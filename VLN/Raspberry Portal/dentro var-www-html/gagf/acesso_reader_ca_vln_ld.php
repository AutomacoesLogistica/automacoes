...
<img id="voltar" src="./images/btn_voltar.png" onclick="javascript: location.href=`menu_cas_vln.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<iframe id='tela' src="http://138.0.77.80:7005/" scrolling=yes resize=yes></iframe>
