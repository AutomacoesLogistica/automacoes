...
<input id="btn_automacoes_bal1"  type="button" value="Automações Balança" disabled=disabled/>
...
<input id="btn_cancelas_mb" type="button" value="Cancelas VLN" onclick="javascript: location.href=`consultar_cancelas_vln.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<input id="btn_controle_excesso" type="button" class="BotaoMenu" value="Controle de Excessos" disabled=disabled/>
<input id="btn_pbt" type="button" value="PBT" disabled=disabled/>
...
<input id="btn_controles" type="button" value="Controles Acesso" onclick="javascript: location.href=`menu_cas_vln.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_dashboard_carretas" type="button" value="DahsBoard Carretas" disabled=disabled/>
<input id="btn_display" type="button" value="Display Balanças" disabled=disabled/>
<input id="btn_Pires" type="button" value="Pires" disabled=disabled/>
