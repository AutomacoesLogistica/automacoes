...
<input id="btn_TV_ca_le"  type="button" value="TV Lado Esquerdo"  onclick="javascript: location.href=`vnc_tv_ca_vln_le.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_reader_le" type="button" value="Reader Lado Esquerdo"  onclick="javascript: location.href=`acesso_reader_ca_vln_le.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_TV_ca_ld" type="button" value="TV Lado Direito" onclick="javascript: location.href=`vnc_tv_ca_vln_ld.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_reader_ld" type="button" value="Reader Lado Direito" onclick="javascript: location.href=`acesso_reader_ca_vln_ld.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_TV_ca_dupla"  type="button" value="Tela DUPLA"  onclick="javascript: location.href=`vnc_tela_dupla.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
INPUT#btn_TV_ca_dupla:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_TV_ca_dupla:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
