                    ...
                    if(mensagem.endswith("'")):
                        ...
                        if (tamanho == 24):
                            if(tag=="442001" and epc != ultima_epc_cavalo):
                                ...
                                url_local2 = 'http://192.168.30.74/dashboard/dashboard_ponto_controle_3.php'
                                dados = {'epc': epc}
                                texto = None
                                try:
                                ...
                                if ( n_leitura == "0" ):
                                    ...
                                    url_local = 'http://192.168.30.74/dashboard/validacao_match.php'
                                    dados = {'rodar':'rodar'}
                                    texto = None
                                    try:
                                    ...
                                    url_local2 = 'http://192.168.30.74/dashboard/verifica_tempo.php'
                                    dados = {'rodar':'rodar'}
                                    texto = None
                                    try:
                                        requisicao = requests.get(url_local2,dados)
