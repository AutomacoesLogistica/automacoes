...
<img id="voltar" src="./images/btn_voltar.png" onclick="javascript: location.href=`tela_poste_display.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<a href="javascript:$.closeit({ direction: 'left', href: 'https://www.globo.com/' })">
