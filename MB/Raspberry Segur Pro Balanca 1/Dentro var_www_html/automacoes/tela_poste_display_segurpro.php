...
<input id="btn_foto_saida_balanca" type="button" value="Visao Saida Balança" onclick='snapshot_2()' />
</div>
...
if($array_condicao[$encontrado]=="Tratando")
{
$cor_da_base = "#F5DEB3";
}
...
$cor_da_base = "#32CD32"; // Verde
  ...
  ?>
    <tr>
        ...
        <td class="th4" style="background-color:<?php print $cor_da_base ?>;"><?php print $array_ponto[$encontrado]?></td>
        <td class="th5" style="background-color:<?php print $cor_da_base ?>;"><?php print $array_condicao[$encontrado]?></td>
        <td class="th6" style="background-color:<?php print $cor_da_base ?>;"><?php print $array_tratado_por_segurpro[$encontrado]?></td>
        <td class="th7" style="background-color:<?php print $cor_da_base ?>;"><?php print $array_tratado_por_ccl[$encontrado]?></td>
        <td class="th8" style="background-color:<?php print $cor_da_base ?>;"><?php print $array_gagf[$encontrado]?></td>
        <td class="th9" style="background-color:<?php print $cor_da_base ?>;"><?php print $array_gscs[$encontrado]?></td>
        <td class="th10" style="background-color:<?php print $cor_da_base ?>;"><?php print $array_material[$encontrado]?></td>
        <td class="th11" style="background-color:<?php print $cor_da_base ?>;"><?php print $array_destino[$encontrado]?></td>
        <td class="th12" style="background-color:<?php print $cor_da_base ?>;"><?php print $array_motorista[$encontrado]?></td>
    </tr>
  <?php
...
function snapshot_2()
{
 location.href=`tela_snapshot2.php?complemento=${criptografia2.value}&check=${criptografia.value}`;    
}
