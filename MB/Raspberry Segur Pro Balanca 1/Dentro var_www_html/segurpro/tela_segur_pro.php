...
<head>
<meta charset="utf-8"/>
<title>Automações Segur Pro</title>
...
<input type="text" id="v_id" name="v_id" value=""/>
<table border= 2px; >
  <thead >
    <tr>
...
if(mysqli_num_rows($sql)>0)
{
 while($dados = $sql->fetch_array())
 {
  ...
  ?>
  <script>
  console.log('<?php print $v_placa_cavalo ?>');
  </script>
  <?php
  ...
  $v_sigla = $dados['sigla_transportadora'];
  $array_destino[$encontrado] = $dados['destino'];
  $array_api_cheio_vazio[$encontrado] = $dados['api_cheio_vazio'];
  ...
  else if ( $array_condicao[$encontrado]=="Concluído" || $array_condicao[$encontrado]=="Saindo da Planta")
  {
  ...
  else if ($array_condicao[$encontrado]=="Concluido2")
  {
   ...
   if($array_api_cheio_vazio[$encontrado]==''){$array_api_cheio_vazio[$encontrado] = "Não Identificado!";}
   $array_condicao[$encontrado]="Concluido</BR><b>Saindo Vazio da Mina!</b></BR>API: ".$array_api_cheio_vazio[$encontrado];
  }
  ...
  else if ($array_condicao[$encontrado]=="Ticket")
  {
  ...
  if($v_sigla == "")
  {
    $v_sigla = "Não identificado!";
  }
  $array_sigla[$encontrado] = $v_sigla;
   ?>
    <tr>
    	<td class="th1" style="background-color:<?php print $cor_da_base ?>;"><?php print $array_data_hora[$encontrado]."</BR>Saída: <b>".$array_ponto[$encontrado]."</b></BR>Motorista: <b>". $array_motorista[$encontrado]."</b>"."</b></BR>Transp.: <b>". $array_sigla[$encontrado]."</b>"?></td>
        ...
        <?php
        if( $array_condicao[$encontrado]=="Concluído" || $array_condicao[$encontrado]=="Saindo da Planta")
        {
            if($array_api_cheio_vazio[$encontrado]==''){$array_api_cheio_vazio[$encontrado]='Não Identificado!';}
        ?>
        <td class="th5" style="background-color:<?php print $cor_da_base ?>;"><?php print $array_condicao[$encontrado]."</BR><b>".$array_destino[$encontrado]."</b>"."</BR>API: ".$array_api_cheio_vazio[$encontrado]    ?></td>
        <?php
        }
        else if($array_condicao[$encontrado]=="Tratando" || $array_condicao[$encontrado]=="Tratando!")
        {
         ?>
         <td class="th5" style="background-color:<?php print $cor_da_base ?>;">
         <input type="button" id="btn_refresh" name="btn_refresh" value="<?php print $array_condicao[$encontrado]?>" onclick="refresh('<?php print $array_id[$encontrado].','.$array_placa_cavalo[$encontrado].','.$array_placa_carreta[$encontrado] ?> ' )"/>        
         </td>
         <?php
        }
        else
        ...
        <?php
         ...
         else if( $array_tratado_por_segurpro[$encontrado] == 'Ticket')
         {
          ?>   
          <input type='button' id='btn_segurpro1' value='Validar' onclick="validar(<?php print $array_id[$encontrado]?>)" />
          <?php
...
<script>
var v_id =  document.getElementById("v_id").innerHTML;
v_id.innerHTML = '<?php print $ultimo_id ?>';
</script>
