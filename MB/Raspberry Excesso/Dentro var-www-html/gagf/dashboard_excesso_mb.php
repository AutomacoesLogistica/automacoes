...
?>
  ...
  <img id="voltar" src="./images/btn_voltar.png" id="voltar" onclick="javascript: location.href=`http://192.168.20.21/gagf/menu_ccl_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
