...
<iframe id="tela_alternativa" src="http://138.0.77.80:3062/gagf/tela_mensagem.php"></iframe>
...
function clicou_atualizar()
{
   ...
   if(v_tela == 0)
   {
    // Esta em 0 e com a tela gagf sendo exibida, altero elas
    tela = 1;
   ...
   {
    //Esta em 1 e com a tela alternativa rodando, altero elas
    tela = 0;
    document.getElementById("tela_alternativa").style.display="none";
...
var utlima_mensagem = "Marcação sendo realizada nos controles da UTMI!"; // Inicia com essa mensagem
var msg_recebida = "";
