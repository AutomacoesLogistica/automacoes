...
<input id="btn_automacoes_bal1"  type="button" value="Automações Balança 01" disabled='disabled'/>
<input id="btn_cancelamento_tickets" class="button" type="button" value="Cancelamento Tickets" disabled='disabled' />
<input id="btn_controle_ttp" class="button" type="button" value="Controle TTP" disabled='disabled'/>
...
<input id="btn_cancelas_mb" type="button" value="Cancelas Miguel Burnier" onclick="javascript: location.href=`consultar_cancelas_utmii.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" disabled="disabled"/>
...
<input id="btn_controle_excesso" type="button" class="BotaoMenu" value="Controle de Excessos" onclick="javascript: location.href=`../dashboard_utmi/utmi/dashboard_excesso_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<input id="btn_controles" type="button" value="Controles de Acesso UTMI" onclick="javascript: location.href=`menu_cas_utmi.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_dashboard_carretas" type="button" value="Dahsboard Carretas" onclick="javascript: location.href=`../dashboard_utmi/utmi/dashboard_utmi.php?vezes=0&nvezes=5&tempo=5000&complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<input id="btn_rom" type="button" value="ROM" disabled="disabled"/>
