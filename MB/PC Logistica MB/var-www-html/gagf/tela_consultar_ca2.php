...
<img id="voltar" src="./images/btn_voltar.png" onclick="javascript: location.href=`tela_consultar_ca.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
{
#BUSCA A FUNCAO ASSOCIANDO O CA DO READER A ANTENA LIDA E BUSCA NO BANCO QUAL A FUNCAO CADASTRADA ******************************************
$sql = $dbcon->query("SELECT * FROM lista_readers WHERE funcao='$funcao2'");
if(mysqli_num_rows($sql)>0)
{
 $num = 0;
 echo"<br/>";echo"<br/>";echo"<br/>";echo"<br/>";
 ...
 while($dados = $sql->fetch_array())
 {
  if($num==0)
  {
   echo "Número de série: <b>".$dados['ca']."</b>";
   echo"<br/>";echo"<br/>";
   echo"A função deste CA é : ";
   echo"<br/>";echo"<br/>";
   $funcao = $dados['funcao'];
