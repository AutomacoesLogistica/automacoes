...
<img id="voltar" src="./images/btn_voltar.png" onclick="javascript: location.href=`menu_automacao11.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<input id="btn_OperacaoMina"  type="button" value="Lista IPs Rede Local"  onclick="javascript: location.href=``;"/>
<input id="btn_Logistica" type="button" value="Lista de IPs Rede Gerdau" onclick="javascript: location.href=``;" />
<input id="btn_Eletrica" type="button" value="Projeto Painéis"   onclick="javascript: location.href=``;"/>
<input id="btn_Patrimonial" type="button" value="Download Arquivos"   onclick="javascript: location.href=``;"/>
