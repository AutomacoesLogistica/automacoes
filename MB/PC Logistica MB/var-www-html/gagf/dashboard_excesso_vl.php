...
?> 
  ...
  <img id="voltar" src="./images/btn_voltar.png" id="voltar" onclick="javascript: location.href=`menu_ccl_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
</body>
