...
<input id="btn_tv_Pires"  type="button" value="TV Pires"  onclick="javascript: location.href=`vnc_tv_pires.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_reader_Pires" type="button" value="Reader Pires" onclick="mensagem()"/><!--onclick="javascript: location.href=`acesso_reader_pires.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" />-->
...
{
    window.document.getElementById('btn_tv_Pires').disabled=false;
...
{
    window.document.getElementById('btn_tv_Pires').disabled=true;
    window.document.getElementById('btn_reader_Pires').disabled=false;
    window.document.getElementById('btn_gestao_ccl_mb').disabled=true;
    window.document.getElementById('btn_gestao_ccl_vl').disabled=true;
}
...
INPUT#btn_tv_Pires:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_tv_Pires:active {
