...
<input id="btn_pbt_mb"  type="button" value="Importar Dados PBT"  onclick="javascript: location.href=`menu_pbt_mb2.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_relatorio_pbt_mb" type="button" value="Relatório PBT" onclick="javascript: location.href=`relatorio_pbt_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" disabled=true/>
...
INPUT#btn_relatorio_pbt_mb:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_relatorio_pbt_mb:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
