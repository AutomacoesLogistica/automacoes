...
<input id="btn_ttp_mb"  type="button" value="Importar Dados TTP"  onclick="javascript: location.href=`menu_ttp_mb2.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_dashboard_ttp_mb" type="button" value="Relatório TTP" onclick="javascript: location.href='relatorio_ttp_mb.php';" disabled=true/>
...
INPUT#btn_ttp_mb:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_ttp_mb:active {
...
INPUT#btn_dashboard_ttp_mb:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_dashboard_ttp_mb:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
