...
<img id="voltar" src="./images/btn_voltar.png" onclick="javascript: location.href=`menu_automacao1.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<input id="btn_publicar_iot"  type="button" value="Publicar Tag IoT"  onclick="javascript: location.href=`tela_publicar_iot.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" disabled/>
<input id="btn_enviar_msg_display_tcp" class="button" type="button" value="Publicar Msg display TCP/IP" disabled/>
<input id="btn_consumir_api_gagf" class="button" type="button" value="Consumir API GAGF" onclick="javascript: location.href=`consumir_api_gagf.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" />
<input id="btn_consultar_ca" class="button"  type="button" value="Consultar CA" onclick="javascript: location.href=`tela_consultar_ca.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" />
<input id="btn_conferencia_automacao_recebimento_rom" class="button" type="button" value="----" />
<input id="btn_cancelas_mb" type="button" value="----" onclick="javascript: location.href=``;"/>
<input id="btn_divergencia_pesagens" type="button" value="----" />
<input id="btn_controle_chamados" type="button" value="----" />
<input id="btn_controle_maquinas" type="button" value="----" />
<input id="btn_controle_excesso" type="button" class="BotaoMenu" value="----" onclick="javascript: location.href=``;"/>
<input id="btn_pbt" type="button" value="----" onclick="javascript: location.href=``;"/>
<input id="btn_controle_ferias" type="button" value="----" />
<input id="btn_df_balancas_rodoviarais" type="button" value="----" />
<input id="btn_contingencia" type="button" value="----" />
<input id="btn_fechamento_turno" type="button"value="----" />
<input id="btn_controles" type="button" value="----" onclick="javascript: location.href=``;"/>
<input id="btn_dashboard_carretas" type="button" value="----" onclick="javascript: location.href=``;"/>
<input id="btn_display" type="button" value="----" onclick="javascript: location.href=``;"/>
<input id="btn_Pires" type="button" value="----" onclick="javascript: location.href=``;"/>
<input id="btn_rom" type="button" value="----" onclick="javascript: location.href=``;"/>
...
INPUT#btn_enviar_msg_display_tcp
{
    color: #FFFFFF;
    margin-left: 0px;
    position: absolute;
...
INPUT#btn_enviar_msg_display_tcp:hover
{
 background-color: #555555; /* Preto */
 color: white;
 box-shadow: 0 5px #666;
...
INPUT#btn_enviar_msg_display_tcp:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
...
INPUT#btn_consumir_api_gagf:hover
{
 background-color: #555555; /* Preto */
 color: white;
 box-shadow: 0 5px #666;
...
INPUT#btn_consumir_api_gagf:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
