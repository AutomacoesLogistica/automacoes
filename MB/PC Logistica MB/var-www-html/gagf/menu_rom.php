...
<input id="btn_automacoes_rom" type="button" value="Automações ROM" onclick="javascript: location.href=`tela_rom.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
INPUT#btn_automacoes_rom:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#bt_nautomacoes_rom:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
