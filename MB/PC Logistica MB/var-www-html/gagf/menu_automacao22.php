...
<input id="btn_OperacaoMina"  type="button" value="Operação de mina"  onclick="javascript: location.href=``;"/>
<input id="btn_Logistica" type="button" value="Logistica" onclick="javascript: location.href=`menu_automacao_logistica_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" />
<input id="btn_Eletrica" type="button" value="Elétrica" />
<input id="btn_Patrimonial" type="button" value="Patrimonial" />
