...
{
?>
<iframe id='tela' src="http://138.0.77.80:5097/vnc.html?host=138.0.77.80&port=5097/" scrolling=no resize=yes></iframe>
<?php
} // Fecha if para ip externo
else
{
?>
<iframe id='tela' src="http://192.168.20.26:6080/vnc.html?host=192.168.20.26&port=6080/" scrolling=no resize=yes></iframe>
<?php
} // Fecha else
?>
