...
<input id="btn_tv_CA_UTMI"  type="button" value="TV CA UTMI"  onclick="javascript: location.href=`vnc_tv_ca_utmi.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_reader_Pires" type="button" value="Reader CA UTMI" onclick="javascript: location.href=`acesso_reader_ca_utmi.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
{
    window.document.getElementById('btn_tv_CA_UTMI').disabled=false;
    window.document.getElementById('btn_reader_Pires').disabled=false;
...
{
    window.document.getElementById('btn_tv_CA_UTMI').disabled=false;
    window.document.getElementById('btn_reader_Pires').disabled=true;
...
{
    window.document.getElementById('btn_tv_CA_UTMI').disabled=true;
    window.document.getElementById('btn_reader_Pires').disabled=false;
    window.document.getElementById('btn_gestao_ccl_mb').disabled=true;
    window.document.getElementById('btn_gestao_ccl_vl').disabled=true;
}
...
INPUT#btn_tv_CA_UTMI:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_tv_CA_UTMI:active {
...
INPUT#btn_reader_Pires:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_reader_Pires:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
