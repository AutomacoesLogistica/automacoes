...
<input id="btn_Logistica" type="button" value="Logistica" onclick="javascript: location.href=`menu_automacao_logistica_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" />
