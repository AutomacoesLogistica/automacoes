...
<input id="btn_pbt_vl"  type="button" value="Importar Dados PBT"  onclick="javascript: location.href=`pbt_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_dashboard_pbt_vl" type="button" value="Dashboard PBT" onclick="javascript: location.href=`grafico_pbt_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" disabled=true/>
...
INPUT#btn_pbt_vl:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_pbt_vl:active {
...
INPUT#btn_dashboard_pbt_vl:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_dashboard_pbt_vl:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
