...
<img id="voltar" src="./images/btn_voltar.png" onclick="javascript: location.href=`menu_automacao_logistica_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<input id="btn_OperacaoMina"  type="button" value="Firmwares Câmeras/NVRs"  onclick="javascript: location.href=`tela_arquivos_programas_logistica_firmware_cameras.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" />
<input id="btn_Logistica" type="button" value="Firmwares Rádios" onclick="javascript: location.href=`tela_arquivos_programas_logistica_firmware_radios.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" />
<input id="btn_Eletrica" type="button" value="Arquivos Diversos" onclick="javascript: location.href=`tela_arquivos_programas_logistica_diversos.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" />/>
<input id="btn_Patrimonial" type="button" value="Programas" onclick="javascript: location.href=`tela_arquivos_programas_logistica_software.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" />
...
INPUT#btn_OperacaoMina:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_OperacaoMina:active {
...
INPUT#btn_Logistica:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_Logistica:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
...
INPUT#btn_Eletrica:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_Eletrica:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
...
INPUT#btn_Patrimonial:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_Patrimonial:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
