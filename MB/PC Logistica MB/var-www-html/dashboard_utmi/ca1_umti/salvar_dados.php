...
{
 include_once 'conexao.php';
 $sql = $dbcon->query("UPDATE dashboard SET epc_cavalo='$tag_do_cavalo',placa_cavalo='$placa_do_cavalo',placa_carreta='$placa_da_carreta',tipo='Controle', ponto='Controle LE UTMI', data_leitura='$data', hora_leitura='$hora' WHERE id='$id_banco_dashboard'");
...
if($encontrados_dashboard == -2 AND $tag_carreta != 'vazio') //Não existe pois perdeu nas entradas, entao crio com o ponto para traz em vazio
{
 ...
 {
  include_once 'conexao.php';
  $sql = $dbcon->query("INSERT INTO dashboard (epc_cavalo,epc_carreta,placa_cavalo,placa_carreta,tipo,ponto,data_leitura,hora_leitura) VALUES ('$tag_do_cavalo','$tag_da_carreta','$placa_do_cavalo','$placa_da_carreta','Controle', 'Controle LE UTMI', '$data', '$hora')");
  //Busco o turno
	$turno1 = '';
  $turno2 = '';
  $turno3 = '';
