...
<body>
   ...
   echo 'ID banco dashboard : ' . $id_banco_dashboard;
    ...
    //mysqli_close();
     ...
     {
      include_once 'conexao.php';
      $sql = $dbcon->query("UPDATE dashboard SET tipo='Saida', ponto='Saida Pires', data_leitura='$data', hora_leitura='$hora' WHERE id='$id_banco_dashboard'");
      //mysqli_close();  
    }
     if($encontrados_historico == 1) // Posso atualizar
     {
      ...
      include_once 'conexao.php';
      $sql = $dbcon->query("UPDATE historico SET encerrado_por='Antena',v_status='Saiu da Planta',valor_ponto='$valor_ponto', $ponto='Saida Pires', $data_leitura='$data', $hora_leitura='$hora' WHERE id='$id_banco_historico'");
      //mysqli_close(); 
