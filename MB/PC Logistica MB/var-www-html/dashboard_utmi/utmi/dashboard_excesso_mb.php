...
else
{
 if(link_vezes != '-1')
 {
   window.setTimeout( "location.href=`./dashboard_excesso_mb.php?vezes=${'<?php print $vezes ?>'}&nvezes=${'<?php print $nvezes ?>'}&tempo=${'<?php print $tempo ?>'}`",link_tempo);
 }   
