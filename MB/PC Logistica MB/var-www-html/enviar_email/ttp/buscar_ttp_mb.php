...
$b_data = isset($_GET['data'])?$_GET['data']:'vazio';
...
$mes = $v[1];
$ano = $v[2];
$nome_arquivo = "Lista_TTP_MB_".$mes.'_'.$ano.".csv";
...
$titulo = "Filtro da lista de TTP MB referente ao mês de ".$v_mes . ' da entrada à saida';
 ?>
