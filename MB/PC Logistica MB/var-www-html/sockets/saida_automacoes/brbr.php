...
<?php
$epc_betruck = "442002000000000000001735";
...
//Agora faço envio para atualizar historico no BeTruck
 ...
 $response = curl_exec($curl);
*/
 $response = '{"statusCode":404,"message":"Nenhuma viagem encontrada","path":"/v1/viagem/atual?tagVeiculo=442002000000000000001735","error":"NotFoundException","traceId":"39e85a445cfa0f230f1d482e1f30a099"}';
