...
$sql = $dbcon->query("INSERT INTO historico_crc(mensagem,mensagem2,crc_display,data_publicacao,hora_publicacao)VALUES('$mensagem','$mensgem2','$crc_display','$data','$hora')");
