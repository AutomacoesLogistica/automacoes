...
$mes = substr($data,3,2);
?>
<label id='titulo'> VA Cheio/Vazio VL - Detecções realizadas em <?php print $data ?></label>
...
location.href=`tela_va_cheio_vazio_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}&data=${data2.value}&complemento=`+link_complemento+`&check=`+ link_check;
