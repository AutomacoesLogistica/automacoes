                ...
                <td class="cheio_vazio_th1">
                  <div id='foto_cheio_vazio'>
                      ...
                      if($justificado == "SIM")
                      {
                       ...
                       ?> 
                       <a href="javascript:cheio_vazio_altera_justificar_cheio_vazio('<?php echo $id ?>');" id="<?php echo $id ?>" style="background-color:#228B22;"  id='justificar' name='justificar'>Parecer Video</a>
                       <script>
                       //alert('verde');
                       </script>
                       <?php
                      ...
                      ?>
                      <a href="javascript:cheio_vazio_altera_justificar_cheio_vazio('<?php echo $id ?>');" id="<?php echo $id ?>" style="background-color:#DC143C;"  id='justificar' name='justificar'>Parecer Video</a>
                      <script>
                       //alert('vermelho');
                       </script>
                      <?php
