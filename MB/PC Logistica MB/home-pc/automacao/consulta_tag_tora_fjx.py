...
def main():
  url_local = 'http://192.168.10.96/automacoes_poste_saida/valida_tag_tora_fjx.php'
          ...
          if(mensagem.endswith("'")):
            ...
            if((len(str(data)))==10 and (len(str(hora)))==8):
              try:
                ...
                sql = "UPDATE atualizacao_services SET data_atualizacao = %s, hora_atualizacao = %s WHERE id = 16"
                val = (data, hora)
