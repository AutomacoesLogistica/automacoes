...
<?php
include_once 'conexao_display_vl.php';
$mensagem1 ="";
$mensagem2 = "";
$peso = "";
$semaforo_entrada = "";
...
$sql = $aux_conexao_display->query("SELECT * FROM balanca_03 WHERE id='1'");
if(mysqli_num_rows($sql)>0)
{
 while($dados = $sql->fetch_array())
 {
...
{
 $mensagem1 = "  Balanca 03 - VL   ";
 $mensagem2 = "  Varzea do Lopes   ";
}else
{
 if($mensagem1 == "")
 {
...
<img class="semaforos" src=<?php print $caminho.$semaforo_entrada.".png"?> id="can2_pat" onclick="javascript: location.href=`display_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
</div>
