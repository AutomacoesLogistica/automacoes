...
{ 
    ...
    <input id="btn_automacao"  type="button" value="Automação Logística"  onclick="javascript: location.href='';" disabled = true/>
    <input id="btn_cco" type="button" value="Centro Controle Operacional" onclick="javascript: location.href='';" disabled = true/>
    ...
    <input id="btn_gestao_gagf" type="button" value="Gestão GAGF"  onclick="javascript: location.href=`menu_gestao_gagf.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"disabled = true/>
