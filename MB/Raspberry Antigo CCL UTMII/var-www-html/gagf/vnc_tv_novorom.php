...
{
?>
<iframe id='tela' src="http://138.0.77.80:5045/vnc.html?host=138.0.77.80&port=5045/" scrolling=no resize=yes></iframe>
<?php
} // Fecha if para ip externo
else
{
?>
<iframe id='tela' src="http://192.168.20.42:6080/vnc.html?host=192.168.20.42&port=6080/" scrolling=no resize=yes></iframe>
<?php
} // Fecha else
?>
