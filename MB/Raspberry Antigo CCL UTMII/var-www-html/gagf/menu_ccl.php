...
<input id="btn_ccl_mb"  type="button" value="CCL Miguel Burnier"  onclick="javascript: location.href=`menu_ccl2.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_ccl_vl" type="button" value="CCL Várzea do Lopes" onclick="javascript: location.href=`menu_ccl_aux.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"disabled = true/>
<input id="btn_gestao_ccl_mb" type="button" value="Gestão CCL MB" />
<input id="btn_gestao_ccl_vl" type="button" value="Gestão CCL VL" disabled = true/>
