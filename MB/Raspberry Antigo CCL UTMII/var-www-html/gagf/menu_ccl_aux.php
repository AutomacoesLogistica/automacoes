...
<input id="btn_ccl_vl"  type="button" value="CCL Várzea do Lopes"  onclick="javascript: location.href=`menu_ccl_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_ccl_vln" type="button" value="CCL VLN" onclick="javascript: location.href=`menu_ccl_vln.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_gestao_ccl_vl" type="button" value="Gestão CCL VL" />
<input id="btn_gestao_ccl_vln" type="button" value="Gestão CCL VLN" />
...
{
    window.document.getElementById('btn_ccl_vl').disabled=false;
    window.document.getElementById('btn_ccl_vln').disabled=false;
    window.document.getElementById('btn_gestao_ccl_vl').disabled=false;
    window.document.getElementById('btn_gestao_ccl_vln').disabled=false;
...
else if(funcao=="Administrador")
{
    window.document.getElementById('btn_ccl_vl').disabled=false;
    window.document.getElementById('btn_ccl_vln').disabled=false;
    window.document.getElementById('btn_gestao_ccl_vl').disabled=true;
    window.document.getElementById('btn_gestao_ccl_vln').disabled=true;
}
else if(funcao=="Gestão GAGF")
{
    window.document.getElementById('btn_ccl_vl').disabled=true;
    window.document.getElementById('btn_ccl_vln').disabled=true;
    window.document.getElementById('btn_gestao_ccl_vl').disabled=true;
    window.document.getElementById('btn_gestao_ccl_vln').disabled=true;
}
...
INPUT#btn_ccl_vln:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_ccl_vln:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
...
INPUT#btn_gestao_ccl_vln:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_gestao_ccl_vln:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
