...
<input id="btn_ttp_vl"  type="button" value="Importar Dados TTP"  onclick="javascript: location.href=`ttp_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_dashboard_ttp_vl" type="button" value="Dashboard TTP" onclick="javascript: location.href='grafico_ttp_vl.php';" disabled=true/>
...
INPUT#btn_ttp_vl:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_ttp_vl:active {
...
INPUT#btn_dashboard_ttp_vl:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_dashboard_ttp_vl:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
