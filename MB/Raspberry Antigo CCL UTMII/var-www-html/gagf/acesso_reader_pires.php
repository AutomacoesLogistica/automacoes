...
<img id="voltar" src="./images/btn_voltar.png" onclick="javascript: location.href=`menu_pires.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<iframe id='tela' src="http://138.0.77.80:8002/" scrolling=yes resize=yes></iframe>
