...
<link rel="stylesheet" type="text/css" href="./css/menu_ccl_vl.css" media="screen" />
...
<input id="btn_controle_ttp" class="button" type="button" value="Controle TTP" onclick="javascript: location.href=`menu_ttp_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<input id="btn_cancelas_vl" type="button" value="Cancelas Várzea do Lopes" onclick="javascript: location.href=`consultar_cancelas_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<input id="btn_controle_excesso" type="button" class="BotaoMenu" value="Controle de Excessos" onclick="javascript: location.href=`dashboard_excesso_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_pbt" type="button" value="PBT" onclick="javascript: location.href=`menu_pbt_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<input id="btn_dashboard_carretas" type="button" value="DahsBoard Carretas" onclick="javascript: location.href=`grafico_colunas_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_display" type="button" value="Display Balanças" onclick="javascript: location.href=`display_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
INPUT#btn_cancelas_vl:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_cancelas_vl:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
