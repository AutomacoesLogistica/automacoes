...
<input id="btn_reader_Pires" type="button" value="Reader Pires" onclick="javascript: location.href=`acesso_reader_pires.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
