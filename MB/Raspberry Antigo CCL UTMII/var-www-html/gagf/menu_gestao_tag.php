...
<input id="btn_cadastrar_tag"  type="button" value="Cadastrar TAG"  onclick="javascript: location.href=`cadastrar_tag.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_consultar_tag" type="button" value="Consultar TAG" onclick="javascript: location.href=`consultar_tag1.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
INPUT#btn_cadastrar_tag:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_cadastrar_tag:active {
