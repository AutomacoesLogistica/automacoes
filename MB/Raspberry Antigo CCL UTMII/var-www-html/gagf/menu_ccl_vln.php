...
<head>
<meta charset="utf-8"/>
<title>Gerdau :: GAGF</title>
<link rel="shortcut icon" type="imagem/JPG" href="./images/gerdau.jpg";  id="favicon">
<link rel="stylesheet" type="text/css" href="./css/menu_ccl_vln.css" media="screen" />
...
<img id="voltar" src="./images/btn_voltar.png" onclick="javascript: location.href=`menu_ccl_aux.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<input id="btn_cancelamento_processos_gagf"  type="button" value="Cancelamentos Processos GAGF"/>
<input id="btn_cancelamento_tickets" class="button" type="button" value="Cancelamento Tickets" />
<input id="btn_controle_ttp" class="button" type="button" value="Controle TTP" onclick="javascript: location.href=`menu_ttp_vln.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_gestao_bypass" class="button"  type="button" value="Gestão ByPass Automação" />
<input id="btn_conferencia_automacao_recebimento_rom" class="button" type="button" value="Conferência Automação Rec.ROM"  />
<input id="btn_cancelas_vln" type="button" value="Cancelas Várzea do Lopes" onclick="javascript: location.href=`consultar_cancelas_vln.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_divergencia_pesagens" type="button" value="Divergência de Pesagens" />
<input id="btn_controle_chamados" type="button" value="Controle de Chamados" />
<input id="btn_controle_maquinas" type="button" value="Controle das Máquinas" />
<input id="btn_controle_excesso" type="button" class="BotaoMenu" value="Controle de Excessos" onclick="javascript: location.href=`dashboard_excesso_vln.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_pbt" type="button" value="PBT" onclick="javascript: location.href=`menu_pbt_vln.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_controle_ferias" type="button" value="Controle de Férias" />
<input id="btn_df_balancas_rodoviarais" type="button" value="DF Balanças Rodoviarias" />
<input id="btn_contingencia" type="button" value="Contingência" />
<input id="btn_fechamento_turno" type="button"value="Fechamento Turno"/>
<input id="btn_diversos" type="button" value="Diversos" />
<input id="btn_dashboard_carretas" type="button" value="DahsBoard Carretas" onclick="javascript: location.href=`grafico_colunas_vln.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_display" type="button" value="Display Balanças" onclick="javascript: location.href=`display_vln.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
INPUT#btn_cancelamento_processos_gagf
{
    color: #FFFFFF;
    margin-left: 0px;
    position: absolute;
...
INPUT#btn_cancelamento_processos_gagf:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_cancelamento_processos_gagf:active {
...
INPUT#btn_cancelas_vln:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_cancelas_vln:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
