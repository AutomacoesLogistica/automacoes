...
<head>
    ...
    <title>Tela Amostragem MB</title>
</head>
<body>
...
<label id='titulo1' name='titulo1' onclick="javascript: location.href='./tela_mensagem.php'" >Amostragem Miguel Burnier referente ao dia <?php print $data ?></label>
