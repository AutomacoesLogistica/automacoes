    ...
    def run(self):
        ...
        while self._running:
            ...
            time.sleep(2); # Espera 2 Segundos!
                ...
                # FALTA SALVAR DENTRO DO BANCO PARA CASAR ESSA INFORMA��O PARA SER O MATCH DO DIPS
                        ...
                        if (tamanho == 24):
                            if(tag=="442001" and epc != ultima_epc_cavalo):
                                ...
                                if(antena=="2"):
                                    ...
                                    #   )
                                    #   mycursor = mydb.cursor()
                                    #   sql = "INSERT INTO Controle_1_01(ponto, condicao, dia,mes,ano,vdata, vhora,data_hora,epc) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
                                    ...
                                    #    )
                                    #    mycursor = mydb.cursor()
                                    #    sql = "UPDATE atualizacao SET antena0 = %s WHERE ponto='Controle 1'"
                                    #    msg = ('OK',)
                                    #    mycursor.execute(sql,msg);
                                    #    mydb.commit();
                                    #except Exception as e:
								    ...
								    #Salvo como antena 1 - FISICAMENTE HJ � A 3
                                    ...
                                    #    )
                                    #    mycursor = mydb.cursor()
                                    #    sql = "UPDATE atualizacao SET antena1 = %s WHERE ponto='Controle 1'"
                                    #    msg = ('OK',)
                                    #    mycursor.execute(sql,msg);
                                    #    mydb.commit();
                                    #except Exception as e:
                                ...
                                if(str(antena) == "0" or str(antena) == "1"):
                                    print("Publicando para entrada")
                                    url_local2 = 'http://192.168.20.66/dashboard/dashboard_ponto_recebimento_rom_entrada.php'
                                    dados = {'epc': str(epc), 'antena': str(antena) }
                                    texto = None
                                    try:
                                    ...
                                    url_local2 = 'http://192.168.20.66/dashboard/dashboard_ponto_recebimento_rom_saida.php'
                                    dados = {'epc': epc, 'antena': antena }
                                    texto = None
                                    try:
                                        requisicao = requests.get(url_local2,dados)
                                        texto = str(requisicao)
                                ...
                                if(str(antena) == "0" or str(antena) == "1"):
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "INSERT INTO historico_match (epc_cavalo,placa_cavalo,epc_carreta,placa_carreta,tratado,condicao) VALUES (%s, %s, %s, %s, %s, %s)"
                                        msg = (ultima_epc_cavalo,"-",ultima_epc_carreta,"-","nao","entrando",);
                                        mycursor.execute(sql,msg);
                                        mydb.commit()
                                    except Exception as e:
                                        print("Requisicao deu erro:", e)
                                    ...
                                    url_local = 'http://192.168.20.66/dashboard/validacao_match_entrando.php'
                                    dados = {'rodar':'rodar'}
                                    texto = None
                                    try:
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "INSERT INTO historico_match (epc_cavalo,placa_cavalo,epc_carreta,placa_carreta,tratado,condicao) VALUES (%s, %s, %s, %s, %s, %s)"
                                        msg = (ultima_epc_cavalo,"-",ultima_epc_carreta,"-","nao","saindo",);
                                        mycursor.execute(sql,msg);
                                        mydb.commit()
                                    except Exception as e:
                                        print("Requisicao deu erro:", e)

                                    url_local = 'http://192.168.20.66/dashboard/validacao_match_saindo.php'
                                    dados = {'rodar':'rodar'}
                                    texto = None
                                    try:
                                        requisicao = requests.get(url_local,dados)
                                ...
                                url_local2 = 'http://192.168.20.66/dashboard/verifica_tempo.php'
                                dados = {'rodar':'rodar'}
                                texto = None
                                try:
                                    requisicao = requests.get(url_local2,dados)
                            ...
                            if (leitura_geral >10 or leitura_geral< -10):
                                ...
                                if(leituras_0 == 0):
                                    ...
                                    try:
                                        ...
                                        msg = ("0","Controle de Acesso 1","nao",data_leitura, hora_leitura,);
                                        mycursor.execute(sql,msg);
                                        mydb.commit()
                                    except Exception as e:
                                        print("Requisicao deu erro:", e)
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "INSERT INTO alerta_antenas(antena,local,tratado, data_leitura, hora_leitura) VALUES (%s, %s, %s, %s, %s)"
                                        msg = ("1","Controle de Acesso 1","nao", data_leitura, hora_leitura,);
                                        mycursor.execute(sql,msg);
                                        mydb.commit()
                                    except Exception as e:
                                        print("Requisicao deu erro:", e)
...
while Exit==False:
 ...
 if(ciclo ==2): print("rodando")#GPIO.output(LED_rodando,#GPIO.HIGH);
 if(ciclo ==4):
    ...
    #    )
    #    mycursor = mydb.cursor()
    #    sql = "UPDATE atualizacao SET data_atualizacao = %s, hora_atualizacao = %s WHERE ponto='Controle 1'"
    #    msg = (data_atualizacao, hora_atualizacao,)
    #    mycursor.execute(sql,msg);
    #    mydb.commit();
    #except Exception as e:
