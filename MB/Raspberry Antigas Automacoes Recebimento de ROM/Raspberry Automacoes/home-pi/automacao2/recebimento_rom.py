                    ...
                    if(mensagem.endswith("'")):
                        ...
                        if (tamanho == 24):
                            if(tag=="442001" and epc != ultima_epc_cavalo):
                                ...
                                #url_local2 = 'http://192.168.20.66/dashboard/dashboard_recebimento_rom.php'
                                #dados = {'epc': epc}
                                #texto = None
                                #try:
                            ...
                            if (leitura_geral >10 or leitura_geral< -10):
                                ...
                                if(leituras_0 == 0):
                                    ...
                                    try:
                                        ...
                                        msg = ("0","Controle de Acesso 3","nao",data_leitura, hora_leitura,);
                                        mycursor.execute(sql,msg);
                                        mydb.commit()
                                    except Exception as e:
                                        print("Requisicao deu erro:", e)
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "INSERT INTO alerta_antenas(antena,local,tratado, data_leitura, hora_leitura) VALUES (%s, %s, %s, %s, %s)"
                                        msg = ("1","Controle de Acesso 3","nao", data_leitura, hora_leitura,);
                                        mycursor.execute(sql,msg);
                                        mydb.commit()
                                    except Exception as e:
                                        print("Requisicao deu erro:", e)
