...
#define mqtt_topico_sub1           "dev/test/gerdau/maquinas"    //TÃ³pico para publicar o comando de inverter o pino do outro ESP8266
#define mqtt_topico_sub2           "dev/test/gerdau/cancelas"
