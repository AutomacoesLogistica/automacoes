...
//byte ip[] = { 192, 168, 3, 199 }; // Define o IP do arduino CADA UM DEVE TER O SEU
String ValorIP = "192.168.3.199"; // Colocar o mesmo que ip, este serve para impressao via mqtt
...
void setup()
{
  ...
  // Parte do OTA
  ArduinoOTA.setHostname("central_externa"); // nome que ira aparecer na rede
...
void loop()
{
 ArduinoOTA.handle(); // Não retirar, OBRIGATORIO para funcionar em OTA
