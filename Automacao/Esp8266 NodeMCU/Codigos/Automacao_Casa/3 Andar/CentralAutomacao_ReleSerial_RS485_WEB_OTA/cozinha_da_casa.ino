void cozinha()
{
  ...
  if ( readString.indexOf("teto_cozinha") >= 0  ||  readString.indexOf("cozinha4") >= 0)
  {
    intertrava = 0;
 ...
 // ***************************************************************************************************************************************************************************************
  ...
  if ( readString.indexOf("pend_cozinha") >= 0 ||  readString.indexOf("cozinha6") >= 0)
  {
    intertrava = 0;
 ...
 // ***************************************************************************************************************************************************************************************
  ...
  if ( readString.indexOf("amb_ptv_coz") >= 0 ||  readString.indexOf("cozinha5") >= 0)
  {
    intertrava = 0;
