/*
 * CODIGO USADO PARA CONTROLAR A ILUMINAÇÃO RGB DA ILHA - ESP8266 
...
IPAddress staticIP(192, 168, 20, 90);
...
// MQTT: Topicos
// Estado
const PROGMEM char* MQTT_LIGHT_STATE_TOPIC = "dev/test/minhacasa/cz/ilha/status";
const PROGMEM char* MQTT_LIGHT_COMMAND_TOPIC = "dev/test/minhacasa/cz/ilha/comando";

// Brilho
const PROGMEM char* MQTT_LIGHT_BRIGHTNESS_STATE_TOPIC = "dev/test/minhacasa/cz/ilha/brilho/status";
const PROGMEM char* MQTT_LIGHT_BRIGHTNESS_COMMAND_TOPIC = "dev/test/minhacasa/cz/ilha/brilho/setar";

// Cores(rgb)
const PROGMEM char* MQTT_LIGHT_RGB_STATE_TOPIC = "dev/test/minhacasa/cz/ilha/rgb/status";
const PROGMEM char* MQTT_LIGHT_RGB_COMMAND_TOPIC = "dev/test/minhacasa/cz/ilha/rgb/setar";
...
const PROGMEM uint8_t RGB_LIGHT_RED_PIN = 5;//D1 //Desativado fisicamente
const PROGMEM uint8_t RGB_LIGHT_GREEN_PIN = 14; //D5 // Desativado fisicamente
const PROGMEM uint8_t RGB_LIGHT_BLUE_PIN = 4; // D2 // Acende os 3 TIP122

// Variaveis de BUFFER para envio e recepcao do MQTT
const uint8_t MSG_BUFFER_SIZE = 20;
char m_msg_buffer[MSG_BUFFER_SIZE]; 

WiFiClient cz_ilha_rgb;
PubSubClient client(cz_ilha_rgb);
ESP8266HTTPUpdateServer atualizadorOTA_cz_ilha_rgb; //Este e o objeto que permite atualizacao do programa via wifi (OTA)
ESP8266WebServer servidorWeb_cz_ilha_rgb(80); //Servidor Web na porta 80

String dispositivo = "ESP8266 Controlador RGB da Ilha Cozinha";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  servidorWeb_cz_ilha_rgb.on("/", ChamPaginaWeb);
}//Fecha void Pagina 
void ChamPaginaWeb() {servidorWeb_cz_ilha_rgb.send(200, "text/html", paginaWeb);}
...
void publishRGBColor() 
{
 ...
 client.publish("dev/test/minhacasa/cz/ilha/red",m_msg_buffer);//Publica o valor de vermelho
 snprintf(m_msg_buffer, MSG_BUFFER_SIZE, "%d", m_rgb_green);
 client.publish("dev/test/minhacasa/cz/ilha/green",m_msg_buffer);//Publica o valor de verde
 snprintf(m_msg_buffer, MSG_BUFFER_SIZE, "%d", m_rgb_blue);
 client.publish("dev/test/minhacasa/cz/ilha/blue",m_msg_buffer);//Publica o valor de azul
...
void setup() {
  ...
  atualizadorOTA_cz_ilha_rgb.setup(&servidorWeb_cz_ilha_rgb);
  servidorWeb_cz_ilha_rgb.begin();
...
void loop() {
 ...
 {
  servidorWeb_cz_ilha_rgb.handleClient();
 }
