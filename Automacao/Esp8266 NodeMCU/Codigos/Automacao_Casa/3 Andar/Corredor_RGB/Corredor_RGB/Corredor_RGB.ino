...
// MQTT: Topicos
// Estado
const PROGMEM char* MQTT_LIGHT_STATE_TOPIC = "dev/test/minhacasa/cz/corredor/status";
const PROGMEM char* MQTT_LIGHT_COMMAND_TOPIC = "dev/test/minhacasa/cz/corredor/comando";

// Brilho
const PROGMEM char* MQTT_LIGHT_BRIGHTNESS_STATE_TOPIC = "dev/test/minhacasa/cz/corredor/brilho/status";
const PROGMEM char* MQTT_LIGHT_BRIGHTNESS_COMMAND_TOPIC = "dev/test/minhacasa/cz/corredor/brilho/setar";

// Cores(rgb)
const PROGMEM char* MQTT_LIGHT_RGB_STATE_TOPIC = "dev/test/minhacasa/cz/corredor/rgb/status";
const PROGMEM char* MQTT_LIGHT_RGB_COMMAND_TOPIC = "dev/test/minhacasa/cz/corredor/rgb/setar";
...
WiFiClient corredor_rbg;
PubSubClient client(corredor_rbg);

ESP8266HTTPUpdateServer atualizadorOTA_corredor_rbg; //Este e o objeto que permite atualizacao do programa via wifi (OTA)
ESP8266WebServer servidorWeb_corredor_rbg(80); //Servidor Web na porta 80


String dispositivo = "ESP8266 Controlador RGB do Corredor da Cozinha";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  servidorWeb_corredor_rbg.on("/", ChamPaginaWeb);
}//Fecha void Pagina 
void ChamPaginaWeb() {servidorWeb_corredor_rbg.send(200, "text/html", paginaWeb);}
...
void publishRGBColor() 
{
 ...
 client.publish("dev/test/minhacasa/cz/corredor/red",m_msg_buffer);//Publica o valor de vermelho
 snprintf(m_msg_buffer, MSG_BUFFER_SIZE, "%d", m_rgb_green);
 client.publish("dev/test/minhacasa/cz/corredor/green",m_msg_buffer);//Publica o valor de verde
 snprintf(m_msg_buffer, MSG_BUFFER_SIZE, "%d", m_rgb_blue);
 client.publish("dev/test/minhacasa/cz/corredor/blue",m_msg_buffer);//Publica o valor de azul
}
...
void setup() {
  ...
  atualizadorOTA_corredor_rbg.setup(&servidorWeb_corredor_rbg);
  servidorWeb_corredor_rbg.begin();
}
...
void loop() {
 ...
 {
  servidorWeb_corredor_rbg.handleClient();
 }
}
