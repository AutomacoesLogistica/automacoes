/*
 * CODIGO USADO PARA CONTROLAR A ILUMINAÇÃO RGB DA PIA COZINHA - ESP8266 
...
// MQTT: Topicos
// Estado
const PROGMEM char* MQTT_LIGHT_STATE_TOPIC = "dev/test/minhacasa/cz/pia/status";
const PROGMEM char* MQTT_LIGHT_COMMAND_TOPIC = "dev/test/minhacasa/cz/pia/comando";

// Brilho
const PROGMEM char* MQTT_LIGHT_BRIGHTNESS_STATE_TOPIC = "dev/test/minhacasa/cz/pia/brilho/status";
const PROGMEM char* MQTT_LIGHT_BRIGHTNESS_COMMAND_TOPIC = "dev/test/minhacasa/cz/pia/brilho/setar";

// Cores(rgb)
const PROGMEM char* MQTT_LIGHT_RGB_STATE_TOPIC = "dev/test/minhacasa/cz/pia/rgb/status";
const PROGMEM char* MQTT_LIGHT_RGB_COMMAND_TOPIC = "dev/test/minhacasa/cz/pia/rgb/setar";
...
WiFiClient pia_cozinha_rgb;
PubSubClient client(pia_cozinha_rgb);

ESP8266HTTPUpdateServer atualizadorOTA_pia_cozinha_rgb; //Este e o objeto que permite atualizacao do programa via wifi (OTA)
ESP8266WebServer servidorWeb_pia_cozinha_rgb(80); //Servidor Web na porta 80

String dispositivo = "ESP8266 Controlador RGB da Pia da Cozinha";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  servidorWeb_pia_cozinha_rgb.on("/", ChamPaginaWeb);
}//Fecha void Pagina 
void ChamPaginaWeb() {servidorWeb_pia_cozinha_rgb.send(200, "text/html", paginaWeb);}
...
void publishRGBColor() 
{
 ...
 client.publish("dev/test/minhacasa/cz/pia/red",m_msg_buffer);//Publica o valor de vermelho
 snprintf(m_msg_buffer, MSG_BUFFER_SIZE, "%d", m_rgb_green);
 client.publish("dev/test/minhacasa/cz/pia/green",m_msg_buffer);//Publica o valor de verde
 snprintf(m_msg_buffer, MSG_BUFFER_SIZE, "%d", m_rgb_blue);
 client.publish("dev/test/minhacasa/cz/pia/blue",m_msg_buffer);//Publica o valor de azul
}
...
void setup() {
  ...
  atualizadorOTA_pia_cozinha_rgb.setup(&servidorWeb_pia_cozinha_rgb);
  servidorWeb_pia_cozinha_rgb.begin();
}
...
void loop() {
 ...
 {
  servidorWeb_pia_cozinha_rgb.handleClient();
 }
  client.loop();
}
