/*
 * CODIGO PARA ESP8266 NODEMCU - CONTROLADOR RGB PIA ESPACO GOURMET 
 * 
...
// MQTT: Topicos
// Estado
const PROGMEM char* MQTT_LIGHT_STATE_TOPIC = "dev/test/minhacasa/espgourmet/pia/status";
const PROGMEM char* MQTT_LIGHT_COMMAND_TOPIC = "dev/test/minhacasa/espgourmet/pia/comando";

// Brilho
const PROGMEM char* MQTT_LIGHT_BRIGHTNESS_STATE_TOPIC = "dev/test/minhacasa/espgourmet/pia/brilho/status";
const PROGMEM char* MQTT_LIGHT_BRIGHTNESS_COMMAND_TOPIC = "dev/test/minhacasa/espgourmet/pia/brilho/setar";

// Cores(rgb)
const PROGMEM char* MQTT_LIGHT_RGB_STATE_TOPIC = "dev/test/minhacasa/espgourmet/pia/rgb/status";
const PROGMEM char* MQTT_LIGHT_RGB_COMMAND_TOPIC = "dev/test/minhacasa/espgourmet/pia/rgb/setar";
...
WiFiClient pia_espgourmet_rbg;
PubSubClient client(pia_espgourmet_rbg);
ESP8266HTTPUpdateServer atualizadorOTA_pia_espgourmet_rbg; //Este e o objeto que permite atualizacao do programa via wifi (OTA)
ESP8266WebServer servidorWeb_pia_espgourmet_rbg(80); //Servidor Web na porta 80

String dispositivo = "ESP8266 Controlador RGB da Pia do Espaço Gourmet";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  servidorWeb_pia_espgourmet_rbg.on("/", ChamPaginaWeb);
}//Fecha void Pagina 
void ChamPaginaWeb() {servidorWeb_pia_espgourmet_rbg.send(200, "text/html", paginaWeb);}
...
void publishRGBColor() 
{
 ...
 client.publish("dev/test/minhacasa/espgourmet/pia/red",m_msg_buffer);//Publica o valor de vermelho
 snprintf(m_msg_buffer, MSG_BUFFER_SIZE, "%d", m_rgb_green);
 client.publish("dev/test/minhacasa/espgourmet/pia/green",m_msg_buffer);//Publica o valor de verde
 snprintf(m_msg_buffer, MSG_BUFFER_SIZE, "%d", m_rgb_blue);
 client.publish("dev/test/minhacasa/espgourmet/pia/blue",m_msg_buffer);//Publica o valor de azul
...
void setup() {
  ...
  atualizadorOTA_pia_espgourmet_rbg.setup(&servidorWeb_pia_espgourmet_rbg);
  servidorWeb_pia_espgourmet_rbg.begin();
}
...
void loop() {
 ...
 {
  servidorWeb_pia_espgourmet_rbg.handleClient();
 }
  client.loop();
}
