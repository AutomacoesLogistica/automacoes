...
//#define mqtt_topico_sub1           "/iot4decision/gerdau/reader/+/antenna/#"    //TÃ³pico para publicar o comando de inverter o pino do outro ESP8266
#define mqtt_topico_sub1           "/gerdau/maquinas"    //TÃ³pico para publicar o comando de inverter o pino do outro ESP8266
#define mqtt_topico_sub2           "/gerdau/cancelas"
...
void atualizar_mensagem(char* topico, byte* mensagem, unsigned int tamanho) 
{
 ...
 //Enviar = ""; //Limpa os dados da ultima mensagem enviada
 // Dados da mensagem
 //    25/07/2019,17:43:58-442002000000000000000353+CA16002919*0;
