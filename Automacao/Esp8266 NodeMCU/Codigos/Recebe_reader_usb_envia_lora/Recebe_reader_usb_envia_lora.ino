...
String readString = "epc=442002000000000000001216,ant=0,host=PIRESTESTE,data=2020/05/06,hora=07:18:09.442";
void setup()
{
  Serial.begin(115200);
...
void loop()
{
  //epc=442002000000000000001216,ant=0,host=PIRESTESTE,data=2020/05/06,hora=07:18:09.442
  b = strtok(readString, ",");
  Serial.println(b);
