...
void loop()  
{
 ...
 {  
  ...
  if(SINAIS[0]==10){digitalWrite(13,LOW);}
  if(SINAIS[1]==10){digitalWrite(13,LOW);}     
  if(SINAIS[2]==10){digitalWrite(13,LOW);}
  // SE RECEBER O VALOR EM 1000 ENVIADO DA CENTRAL, ALTERA O STATUS DA LAMPADA
  if(SINAIS[0]==1000){digitalWrite(13,!digitalRead(13));}
  if(SINAIS[1]==1000){digitalWrite(13,!digitalRead(13));}
  if(SINAIS[2]==1000){digitalWrite(13,!digitalRead(13));}    
