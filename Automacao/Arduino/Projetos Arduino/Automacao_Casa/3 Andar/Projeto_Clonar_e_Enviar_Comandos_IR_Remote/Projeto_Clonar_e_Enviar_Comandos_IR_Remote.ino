...
PushButton botaoLeitura2(pinBot2);

// DECLARAÇÃO VARIÁVEIS GLOBAIS
bool lerComando = false;


char BT_Input_Code[] = "EF6A95";
...
void loop() {
  ...
  if (botaoLeitura2.pressed() && comando != "") 
  {
   Serial.print("Comando = ");
   Serial.println(comando);
   
   unsigned long Hex_Value = strtoul(comando, NULL, 16);
   emissorIR.sendNEC(Hex_Value,frequencia);
  }
  ...
  if (Serial.available()) {
    ...
    switch (tecla) {
      ...
      case 'd':
        ...
        emissorIR.sendNEC(0xEFAA55,frequencia);
        break;
    }
  }
}
