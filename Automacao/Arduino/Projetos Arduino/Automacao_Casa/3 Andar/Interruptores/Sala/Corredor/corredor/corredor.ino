...
String Mensagem_1 = "=*sala13*="; 
String Mensagem_especial_1 = "=*esp_sala13*="; 

String Mensagem_2 = "=*sala14*="; 
String Mensagem_especial_2 = "=*esp_sala14*="; 

String Mensagem_3 = "=*sala15*="; 
String Mensagem_especial_3 = "=*esp_sala15*="; 
