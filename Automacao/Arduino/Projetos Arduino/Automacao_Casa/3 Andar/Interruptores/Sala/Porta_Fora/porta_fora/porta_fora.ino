...
String Mensagem_1 = "=*sala1*="; 
String Mensagem_especial_1 = "=*esp_sala1*="; 

String Mensagem_2 = "=*sala2*="; 
String Mensagem_especial_2 = "=*esp_sala2*="; 

String Mensagem_3 = "=*sala3*="; 
String Mensagem_especial_3 = "=*esp_sala3*="; 
