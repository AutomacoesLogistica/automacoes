...
String Mensagem_1 = "=*sala4*="; 
String Mensagem_especial_1 = "=*esp_sala4*="; 

String Mensagem_2 = "=*sala5*="; 
String Mensagem_especial_2 = "=*esp_sala5*="; 

String Mensagem_3 = "=*sala6*="; 
String Mensagem_especial_3 = "=*esp_sala6*="; 
