...
String Mensagem_1 = "=*sala7*="; 
String Mensagem_especial_1 = "=*esp_sala7*="; 

String Mensagem_2 = "=*sala8*="; 
String Mensagem_especial_2 = "=*esp_sala8*="; 

String Mensagem_3 = "=*sala9*="; 
String Mensagem_especial_3 = "=*esp_sala9*="; 
