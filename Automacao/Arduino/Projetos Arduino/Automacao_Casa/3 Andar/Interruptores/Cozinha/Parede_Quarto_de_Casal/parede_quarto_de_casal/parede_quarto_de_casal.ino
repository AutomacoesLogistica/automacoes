...
String Mensagem_1 = "=*cozinha4*="; 
String Mensagem_especial_1 = "=*esp_cozinha4*="; 

String Mensagem_2 = "=*cozinha5*="; 
String Mensagem_especial_2 = "=*esp_cozinha5*="; 

String Mensagem_3 = "=*cozinha6*="; 
String Mensagem_especial_3 = "=*esp_cozinha6*="; 
