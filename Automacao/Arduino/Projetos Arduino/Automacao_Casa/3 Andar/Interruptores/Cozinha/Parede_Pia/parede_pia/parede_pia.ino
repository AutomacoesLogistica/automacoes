...
String Mensagem_1 = "=*cozinha7*="; 
String Mensagem_especial_1 = "=*esp_cozinha7*="; 

String Mensagem_2 = "=*cozinha8*="; 
String Mensagem_especial_2 = "=*esp_cozinha8*="; 

String Mensagem_3 = "=*cozinha9*="; 
String Mensagem_especial_3 = "=*esp_cozinha9*="; 
