...
String Mensagem_1 = "=*quartoc7*="; 
String Mensagem_especial_1 = "=*esp_quartoc7*="; 

String Mensagem_2 = "=*quartoc8*="; 
String Mensagem_especial_2 = "=*esp_quartoc8*="; 

String Mensagem_3 = "=*quartoc9*="; 
String Mensagem_especial_3 = "=*esp_quartoc9*="; 
