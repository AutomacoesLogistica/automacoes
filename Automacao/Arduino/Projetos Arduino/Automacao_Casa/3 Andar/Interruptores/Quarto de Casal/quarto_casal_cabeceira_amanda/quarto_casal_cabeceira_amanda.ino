...
String Mensagem_1 = "=*quartoc4*="; 
String Mensagem_especial_1 = "=*esp_quartoc4*="; 

String Mensagem_2 = "=*quartoc5*="; 
String Mensagem_especial_2 = "=*esp_quartoc5*="; 

String Mensagem_3 = "=*quartoc6*="; 
String Mensagem_especial_3 = "=*esp_quartoc6*="; 
