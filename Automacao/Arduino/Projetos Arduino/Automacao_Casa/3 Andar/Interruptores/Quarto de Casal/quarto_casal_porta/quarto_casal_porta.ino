...
String Mensagem_1 = "=*quartoc1*="; 
String Mensagem_especial_1 = "=*esp_quartoc1*="; 

String Mensagem_2 = "=*quartoc2*="; 
String Mensagem_especial_2 = "=*esp_quartoc2*="; 

String Mensagem_3 = "=*quartoc3*="; 
String Mensagem_especial_3 = "=*esp_quartoc3*="; 
