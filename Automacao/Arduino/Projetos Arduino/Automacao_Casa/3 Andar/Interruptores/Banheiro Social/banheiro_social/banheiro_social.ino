...
String Mensagem_1 = "=*banso1*="; 
String Mensagem_especial_1 = "=*esp_banso1*="; 

String Mensagem_2 = "=*banso2*="; 
String Mensagem_especial_2 = "=*esp_banso2*="; 

String Mensagem_3 = "=*banso3*="; 
String Mensagem_especial_3 = "=*esp_banso3*="; 
