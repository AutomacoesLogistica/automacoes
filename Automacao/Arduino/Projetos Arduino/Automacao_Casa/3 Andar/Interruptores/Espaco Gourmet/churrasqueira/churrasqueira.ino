...
String Mensagem_1 = "=*espgour1*="; 
String Mensagem_especial_1 = "=*esp_espgour1*="; 

String Mensagem_2 = "=*espgour2*="; 
String Mensagem_especial_2 = "=*esp_espgour2*="; 

String Mensagem_3 = "=*espgour3*="; 
String Mensagem_especial_3 = "=*esp_espgour3*="; 
