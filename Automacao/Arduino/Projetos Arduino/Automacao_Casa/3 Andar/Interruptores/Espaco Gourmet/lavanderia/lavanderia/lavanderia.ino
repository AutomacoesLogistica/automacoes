...
String Mensagem_1 = "=*espgour4*="; 
String Mensagem_especial_1 = "=*esp_espgour4*="; 

String Mensagem_2 = "=*espgour5*="; 
String Mensagem_especial_2 = "=*esp_espgour5*="; 

String Mensagem_3 = "=*espgour6*="; 
String Mensagem_especial_3 = "=*esp_espgour6*="; 
