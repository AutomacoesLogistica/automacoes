/*
    ...
    CODIGO UTILIZANDO UM ARDUINO PRO MINI EM REDE RS485 - CODIGO PARA INTERRUPTOR DO ACESSO / OFICINA
...
String Mensagem_1 = "muro_churra"; // Iluminação do teto da area de churrasco
String Mensagem_2 = "teto_churra"; // Iluminação do Jardim Horizontal
String Mensagem_3 = "portaoP"; // Abrir portao pequeno de acesso
