/*
    ...
    CODIGO UTILIZANDO UM ARDUINO PRO MINI EM REDE RS485 - CODIGO PARA INTERRUPTOR DA AREA DE CHURRASCO
...
String Mensagem_1 = "teto_churra"; // Iluminação do teto da area de churrasco
String Mensagem_2 = "pen_churra"; // Iluminação dos pendentes da area de churrasco
String Mensagem_3 = "amb_churra"; // Iluminação dos quadros da area de churrasco
