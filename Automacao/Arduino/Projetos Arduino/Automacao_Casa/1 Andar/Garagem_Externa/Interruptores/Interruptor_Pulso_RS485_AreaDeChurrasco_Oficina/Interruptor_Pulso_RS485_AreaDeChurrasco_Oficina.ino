/*
    ...
    CODIGO UTILIZANDO UM ARDUINO PRO MINI EM REDE RS485 - CODIGO PARA INTERRUPTOR DA AREA DE CHURRASCO/ OFICINA
...
String Mensagem_1 = "lamp_oficina"; // Iluminação do teto da oficina
String Mensagem_2 = "arandela"; // Iluminação das areandelas do muro da area de churrasco
String Mensagem_3 = "jardim_hori"; // Iluminação das areandelas do muro dos carros
