...
String Mensagem_1 = "carro1"; // Iluminação da frente da casa
String Mensagem_2 = "carro2"; // Iluminação da arandelas dos carros
String Mensagem_3 = "carro3"; // Iluminação do jardim horizontal
