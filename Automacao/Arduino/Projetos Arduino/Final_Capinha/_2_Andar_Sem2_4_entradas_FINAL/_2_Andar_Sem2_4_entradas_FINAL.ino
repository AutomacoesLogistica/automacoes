...
void loop()  
{
 ...
 while (Serial.available()) 
 {
  ...
  readString+=c; 
   ...
   // ATUALIZA A SAIDA 11
   if(readString.indexOf("cen12")>=0)     
   {
    digitalWrite(11,!digitalRead(11));
//    if(digitalRead(11)==1){Serial.println("SINAIS[12]==100");};
//    if(digitalRead(11)==0){Serial.println("SINAIS[12]==50");};
   }
   
   // ATUALIZA A SAIDA 12
   if(readString.indexOf("cen13")>=0)     
   {
    digitalWrite(12,!digitalRead(12));
//    if(digitalRead(12)==1){Serial.println("SINAIS[13]==100");};
 //   if(digitalRead(12)==0){Serial.println("SINAIS[13]==50");};
