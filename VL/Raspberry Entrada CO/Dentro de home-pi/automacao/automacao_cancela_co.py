...
class Classe_Ler_Pulso_do_Reader:
    ...
    def run(self):
        ...
        while self._running:
            if(GPIO.input(Entrada_Pulso_Reader) == 0):
                            ...
                            if(tag=="442001" and epc != ultima_epc_cavalo):
                                ...
                                if(antena=="0"):
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "INSERT INTO Entrada_CO_01(ponto, condicao, dia,mes,ano,vdata, vhora,data_hora,epc) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "UPDATE atualizacao SET antena0 = %s WHERE ponto='Entrada CO'"
                                        msg = ('OK',)
                                        mycursor.execute(sql,msg);
                                        mydb.commit();
                                    except Exception as e:
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "UPDATE atualizacao SET antena1 = %s WHERE ponto='Entrada CO'"
                                        msg = ('OK',)
                                        mycursor.execute(sql,msg);
                                        mydb.commit();
                                    except Exception as e:
                            ...
                            if (leitura_geral >10 or leitura_geral< -10):
                                ...
                                if(leituras_0 == 0):
                                    ...
                                    try:
                                        ...
                                        msg = ("0","Cancela de entrada de congonhas","nao",data_leitura, hora_leitura,);
                                        mycursor.execute(sql,msg);
                                        mydb.commit()
                                    except Exception as e:
                                        print("Requisicao deu erro:", e)
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "INSERT INTO alerta_antenas(antena,local,tratado, data_leitura, hora_leitura) VALUES (%s, %s, %s, %s, %s)"
                                        msg = ("1","Cancela de entrada de congonhas","nao", data_leitura, hora_leitura,);
                                        mycursor.execute(sql,msg);
                                        mydb.commit()
                                    except Exception as e:
                                        print("Requisicao deu erro:", e)
...
while Exit==False:
 ...
 if(ciclo ==4):
    ...
    try:
        ...
        mycursor = mydb.cursor()
        sql = "UPDATE atualizacao SET data_atualizacao = %s, hora_atualizacao = %s WHERE ponto='Entrada CO'"
        msg = (data_atualizacao, hora_atualizacao,)
        mycursor.execute(sql,msg);
        mydb.commit();
    except Exception as e:
 ...
 if (ciclo > 10): Exit = True #Sai do programa
