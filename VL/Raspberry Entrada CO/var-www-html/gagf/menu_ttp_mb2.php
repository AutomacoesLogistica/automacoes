...
<input id="btn_ttp_mb"  type="button" value="Importar Dados TTP MB"  onclick="javascript: location.href=`ttp_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_ttp_usina" type="button" value="Importar Dados TTP UOB" onclick="javascript: location.href=`ttp_uob.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
INPUT#btn_ttp_usina:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_ttp_usina:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
