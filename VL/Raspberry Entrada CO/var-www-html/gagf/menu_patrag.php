...
<input id="btn_display"  type="button" value="Display Balanças" onclick="javascript: location.href=`display_balanca01_patrag.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
