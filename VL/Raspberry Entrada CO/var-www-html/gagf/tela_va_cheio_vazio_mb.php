...
{
  //alert("justificar");
  document.getElementById('div_justificar').style.visibility = 'visible';
...
?>
<label id='titulo'> VA Cheio/Vazio MB - Evendos do dia  <?php print $data ?></label>
...
<label id='titulo2'> Ultima detecção: <?php print $ultima_data ?></label>
     ...
     <table>
        ...
        <tbody>
            ...
            $cameras  = isset($_GET['cameras'])?$_GET['cameras']:"v";
...
<label id="v1">Testando</label>
<label id="v2">Testando</label>
<label id="v3">Testando</label>
<label id="v4">Testando</label>
<label id="v5">Testando</label>
<label id="v6">Testando</label>
...
var d = document.getElementById('data2').value; 
//alert(d);

//alert(resp_cameras);
document.getElementById('div_filtrar').style.display = 'none';
location.href=`tela_va_cheio_vazio_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}&data=${data2.value}&complemento=`+link_complemento+`&check=`+ link_check+`&cameras=`+resp_cameras+`&status=`+resp_cheio_vazio;
...
function clicou_relatorio()
{
    ...
    //Oculta
    document.getElementById('tabela').style.display = 'none'; // Oculta tabela
...
function clicou_dashboard()
{
    ...
    //Oculta
    document.getElementById('v_relatorio').style.display = 'none';//Oculta div relatorio
}
...
function clicou_sim_justificar(link_video)
{
 ...
 document.getElementById('div_justificar').style.visibility = 'hidden';
 document.getElementById("tabela").disabled = false;
 document.getElementById('div_justificativa').style.visibility = 'visible';
}
