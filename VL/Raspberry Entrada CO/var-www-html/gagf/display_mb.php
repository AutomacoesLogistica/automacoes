...
<input id="btn_balanca1"  type="button" value="Balança 01"  onclick="javascript: location.href=`display_balanca01_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_balanca2" type="button" value="Balança 02" onclick="javascript: location.href=`display_balanca02_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_balanca3" type="button" value="Balança 03" onclick="javascript: location.href=`display_balanca03_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
