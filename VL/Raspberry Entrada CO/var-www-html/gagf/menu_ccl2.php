...
<img id="voltar" src="./images/btn_voltar.png" onclick="javascript: location.href=`menu_ccl.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<input id="btn_ccl_mb"  type="button" value="CCL Miguel Burnier"  onclick="javascript: location.href=`menu_ccl_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_ccl_patrag" type="button" value="Patrag" onclick="javascript: location.href=`menu_patrag.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_gestao_ccl_mb" type="button" value="Gestão CCL MB" />
<input id="btn_gestao_ccl_patrag" type="button" value="Gestão Patrag" />
...
{
    window.document.getElementById('btn_ccl_mb').disabled=false;
    window.document.getElementById('btn_ccl_patrag').disabled=false;
    window.document.getElementById('btn_gestao_ccl_mb').disabled=false;
    window.document.getElementById('btn_gestao_ccl_patrag').disabled=false;
...
else if(funcao=="Administrador")
{
    window.document.getElementById('btn_ccl_mb').disabled=false;
    window.document.getElementById('btn_ccl_patrag').disabled=false;
    window.document.getElementById('btn_gestao_ccl_mb').disabled=true;
    window.document.getElementById('btn_gestao_ccl_patrag').disabled=true;
}
else if(funcao=="Gestão GAGF")
{
    window.document.getElementById('btn_ccl_mb').disabled=true;
    window.document.getElementById('btn_ccl_patrag').disabled=true;
    window.document.getElementById('btn_gestao_ccl_mb').disabled=true;
    window.document.getElementById('btn_gestao_ccl_patrag').disabled=true;
}
...
INPUT#btn_ccl_mb:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_ccl_mb:active {
...
INPUT#btn_ccl_patrag:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_ccl_patrag:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
...
INPUT#btn_gestao_ccl_patrag:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_gestao_ccl_patrag:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
