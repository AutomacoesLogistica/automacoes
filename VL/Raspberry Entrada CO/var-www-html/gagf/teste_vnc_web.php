...
<img id="voltar" src="./images/btn_voltar.png" onclick="javascript: location.href=`menu_pires_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
...
<script>alert("Atenção!:   Usar a senha gerdau10 para logar na tela!");</script>
<?php
error_reporting(0);
...
<iframe id='tela' src="http://138.0.77.80:5044/vnc.html?host=138.0.77.80&port=5044/" scrolling=yes resize=yes></iframe>
