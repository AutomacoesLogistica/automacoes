...
<input id="btn_pbt_mb"  type="button" value="Importar Dados PBT MB"  onclick="javascript: location.href=`pbt_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;"/>
<input id="btn_pbt_usina" type="button" value="Importar Dados PBT UOB" onclick="javascript: location.href=`pbt_mb.php?complemento=${criptografia2.value}&check=${criptografia.value}`;" disabled=true/>
...
INPUT#btn_pbt_mb:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_pbt_mb:active {
...
INPUT#btn_pbt_usina:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#btn_pbt_usina:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
