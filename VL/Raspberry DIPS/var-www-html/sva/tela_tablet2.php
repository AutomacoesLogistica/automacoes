...
function atualizar()
{
    location.href=`tela_tablet2.php`;
}
</script>
...
if(id==0)
{
 ...
 if(link_vez == 3)
 {
    window.setTimeout( "location.href=`tela_tablet2.php?vez=0`",5000);   
 }
 else
 {
    window.setTimeout( "location.href=`tela_tablet2.php?vez=${link_vez}`",3000);   
 }
