...
<label id="lb_cameras_pessoas" hidden="hidden"></label>
<label id="lb_parecer" hidden="hidden"></label>
<label id="lb_parecer_pessoas" hidden="hidden"></label>
...
$link_cameras_pessoas = isset($_GET['cameras_pessoas'])?$_GET['cameras_pessoas']:"todas";
$link_status = isset($_GET['status'])?$_GET['status']:"todos";
$link_parecer = isset($_GET['parecer'])?$_GET['parecer']:"todos";
$link_parecer_pessoas = isset($_GET['parecer_pessoas'])?$_GET['parecer_pessoas']:"todos";
...
function pessoas_altera_video(link_video)
{
 //alert(link_video);
...
function deteccao_falsa_pessoas(link_video)
{
  //alert(link_video);
  document.getElementById('ref1').value = link_video;//atualiza a referencia para apagar
  document.getElementById('div_info_zerar_pessoas').style.display = 'block';
  var link = document.getElementById('lb_info_zerar');
...
function justificar_pessoas(id)
{
  //alert("justificar");
  document.getElementById('div_justificar_pessoas').style.display = 'block';
...
function f_editar_pessoas()
{
  valor_id = document.getElementById('ref1').value;
  //alert(valor_id);
  document.getElementById('pessoas_v_parecer').style.backgroundColor = '#ADD8E6';
  document.getElementById('pessoas_v_parecer').focus();
  document.getElementById('btn_editar_pessoas').style.display = 'none';
  document.getElementById('btn_salvar_editar_pessoas').style.display = 'block';
}
...
function f_salvar_pessoas()
{
  valor_id = document.getElementById('ref1').value;
  //alert(valor_id);
  document.getElementById('pessoas_v_parecer').style.backgroundColor = '#DCDCDC';
  var link = document.getElementById('pessoas_v_parecer');
  var parecer2 = link.value;
  
  $.ajax({
           url: 'valida_salvar_edicao_pessoas.php',
           type: 'GET',
           dataType: 'json',
           data: {'id': valor_id,'parecer': parecer2},
           success: function(resultado){
  ...
  document.getElementById('btn_editar_pessoas').style.display = 'none';
  document.getElementById('btn_salvar_editar_pessoas').style.display = 'none';
}
...
function pessoas_altera_justificar(link_justificar)
{
  var nome1 = '<?php print $nome ?>';
 //alert(link_justificar);
 document.getElementById('ref1').value = link_justificar;
 ...
 //alert(dados);
       $.ajax({
           url: 'consulta_va_ref1_pessoas.php',
           type: 'GET',
           dataType: 'json',
           data: {'id': b},
           success: function(resultado){
           ...
           if(justificado == "NAO" || justificado=="")
           {
            ...
            document.getElementById('btn_salvar_editar_pessoas').style.display = 'none';
            document.getElementById('pessoas_v_parecer').style.backgroundColor = '#DCDCDC';
            justificar_pessoas(link_justificar);
           ...
           else
           {
            if( (String(nome1)).trim() == (String(nome)).trim())
            {
             ...
             //Pode efetuar a edição do texto que ja esta justificado por ele
             //editar_cheio_vazio(link_justificar);
             document.getElementById('btn_editar_pessoas').style.display = 'block';
             document.getElementById('btn_salvar_editar_pessoas').style.display = 'none';
            }
            else
            {
            ...
            document.getElementById('pessoas_v_registro').value = registro;
            document.getElementById('pessoas_v_nome').value = nome;
            document.getElementById('pessoas_v_parecer').value = justificativa;
...
<div id='menu'>
<input type='button' id='btn_cheio_vazio' name='btn_cheio_vazio' onclick='clicou_cheio_vazio()'  disabled/> 
...
<img id='cheio_vazio_btn_filtro' src="./images/local_bar.png" onclick="cheio_vazio_clicou_filtrar();"/>
...
?>
<label id='cheio_vazio_titulo'> VA Cheio/Vazio VL - Eventos do dia  <?php print $data ?></label>
<script>
...
<label id='cheio_vazio_titulo2'> Ultima detecção: <?php print $ultima_data ?></label>
     ...
     <table id='tabela_cheio_vazio'>
        ...
        <tbody id='t_cheio_vazio'>
            ...
            //$hora = date('H:i:s');
            //Dados das cameras
            //ms1041-cam00 - Visão Enloamento Saída CO
            //ms1041-cam01 - Visão Cancelas Saída CO
            //ms1041-cam02 - Subida Cancela Saida CO
            //ms1041-cam03 - Lavador de Báscula
            //ms1041-cam04 - Visão Área das Balanças
            ...
            elseif($cameras == "ckb_1") // OK
            {
             ...
             if($status == "todos")
             {
              $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam04')";
            }
             elseif($status == "apenas_cheio")
             {
              $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam04') AND text='Detect - Cheio'";
             }
             elseif($status == "apenas_vazio")
             {
              $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam04') AND text='Detect - Vazio'";
             }
            ...
            elseif($cameras == "ckb_2") // OK
            {
             ...
             //ms1041-cam01 - Visão Cancelas Saída CO
             //ms1041-cam05 - Saida ROM Cheio
             if($status == "todos")
             {
              $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam05')";
             }
             elseif($status == "apenas_cheio")
             {
              $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam05') AND text='Detect - Cheio'";
             }
             elseif($status == "apenas_vazio")
             {
              /*
              ...
              */
              $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam05') AND text='Detect - Vazio'";
             }
            ...
            elseif($cameras == "ckb_3") // OK
            {
             ...
             if($status == "todos")
             {
             $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam02' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam06')";
             }
             elseif($status == "apenas_cheio")
             {
             $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam02' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam06')  AND text='Detect - Cheio'";
             }
             elseif($status == "apenas_vazio")
             {
             $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam02' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam06')  AND text='Detect - Vazio'";
             }
            }
            elseif($cameras == "ckb_1,ckb_2") // OK
            {
              ...
              if($status == "todos")
              {
               $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam04' OR camera_id='ms1041-cam01' OR camera_id='ms1041-cam05')";
              }
              elseif($status == "apenas_cheio")
              {
               $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam04' OR camera_id='ms1041-cam01' OR camera_id='ms1041-cam05') AND text='Detect - Cheio'";
              }
              elseif($status == "apenas_vazio")
              {
               $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam04' OR camera_id='ms1041-cam01' OR camera_id='ms1041-cam05') AND text='Detect - Vazio'";
              }
            }
            elseif($cameras == "ckb_1,ckb_3") // OK
            {
              ...
              if($status == "todos")
              {
               ...
               $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam04' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam06')";
              }
              elseif($status == "apenas_cheio")
              {
               $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam04' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam06') AND text='Detect - Cheio'";
              }
              elseif($status == "apenas_vazio")
              {
               $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam04' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam06') AND text='Detect - Vazio'";
              }
            }
            elseif($cameras == "ckb_2,ckb_3")
            {
              ...
              //ms1041-cam02 - Subida Cancela Saida CO
              //ms1041-cam03 - Lavador de Báscula
              //ms1041-cam06 - Saida Alternativa ROM Cheio
              if($status == "todos")
              {
               $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam05' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam06')";
              }
              elseif($status == "apenas_cheio")
              {
               $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam05' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam06') AND text='Detect - Cheio'";
              }
              elseif($status == "apenas_vazio")
              {
               $pesquisa = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam05' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam06') AND text='Detect - Vazio'";
              }
            }
            ...
            include_once 'conexao_sva.php';
            $sql = $dbcon->query("SELECT * FROM cheio_vazio WHERE ".$pesquisa." AND deteccao_falsa != 'SIM' ORDER BY id DESC");
            if(mysqli_num_rows($sql)>0)
            {
             while($dados = $sql->fetch_array())
             {
              ...
              if($cam == 'ms1041-cam00'){$cam = 'Visão Enloamento Saída CO';}
              else if ($cam == 'ms1041-cam01'){$cam = 'Visão Cancelas Saída CO';}
              else if ($cam == 'ms1041-cam02'){$cam = 'Subida Cancela Saida CO';}
              else if ($cam == 'ms1041-cam03'){$cam = 'Lavador de Báscula';}
              else if ($cam == 'ms1041-cam04'){$cam = 'Visão Área das Balanças';}
              ...
              if($ip == "192.168.30.1")
              {
               ...
               $url_do_arquivo = str_replace(".30.",".77.",$url_do_arquivo);
               $url_do_arquivo = str_replace(".80:",".80:",$url_do_arquivo);
               $url_do_arquivo = str_replace(":8597",":6078",$url_do_arquivo);
              }
              ...
              <tr>
                <td class="cheio_vazio_th1">
                  <div id='foto_cheio_vazio'>
                      ...
                      <a href="javascript:cheio_vazio_altera_video('<?php echo $url_do_arquivo ?>');" id='assistir'>Assistir</a>
                      <?php
                      if($justificado == "SIM")
                      {
                       ...
                       ?> 
                       <a href="javascript:cheio_vazio_altera_justificar_cheio_vazio('<?php echo $id ?>');" style="background-color:#228B22;"  id='justificar' name='justificar'>Parecer Video</a>
                       <script>
                       //alert('verde');
                       </script>
                       <?php
                      ...
                      ?>
                      <a href="javascript:cheio_vazio_altera_justificar_cheio_vazio('<?php echo $id ?>');" style="background-color:#DC143C;"  id='justificar' name='justificar'>Parecer Video</a>
                      <script>
                       //alert('vermelho');
                       </script>
                      <?php
                      ...
                      ?>
                      <a href="javascript:deteccao_falsa_cheio_vazio('<?php echo $id ?>');" id='ignorar' name='ignorar'>Detecção Falsa</a>
             ...
             <script>
                ...
                document.getElementById('cheio_vazio_info_eventos2').innerHTML = 'Eventos Justificados : '+ n_justificado; 
...
<video id='vcheio_vazio_player1'  class="video-js vjs-default-skin"  controls autoplay>
...
<div id="v_pessoas">
<input type="button" id="btn_editar_pessoas" name="btn_editar_pessoas" value="Editar" onclick="f_editar_pessoas()" />
  <input type="button" id="btn_salvar_editar_pessoas" name="btn_salvar_editar_pessoas" value="Salvar" onclick="f_salvar_pessoas()" />

<img id='pessoas_btn_calendario' src="./images/date_range.png" onclick="cheio_vazio_clicou_exibir_calendario();"/>
<img id='pessoas_btn_filtro' src="./images/local_bar.png" onclick="pessoas_clicou_filtrar();"/>

<div id='dados_pessoas'>
...
<textarea id='pessoas_v_parecer' name='pessoas_v_parecer' name="Text1" cols="56" rows="4">--</textarea>
</div>
...
?>
<label id='pessoas_titulo'> VA Pessoas VL - Eventos do dia  <?php print $data ?></label>
<script>
var data_selecionada = '<?php print $data ?>'; 
</script>
...
<label id='pessoas_titulo2'> Ultima detecção: <?php print $ultima_data ?></label>
     ...
     <table id='tabela_pessoas'>
        ...
        <tbody id='t_pessoas'>
            ...
            //Dados das cameras
            //Atualiza a camera detectada
            //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
            //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
            //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
            //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
            //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças

            
            $cameras_pessoas  = isset($_GET['cameras_pessoas'])?$_GET['cameras_pessoas']:"todas";
            $parecer_pessoas  = isset($_GET['parecer_pessoas'])?$_GET['parecer_pessoas']:"todos";
            
            if($cameras_pessoas == "todas") // OK
            {
             // Todas as câmeras
              $pesquisa_pessoas = "data_leitura='$data'";
            }
                       
            elseif($cameras_pessoas == "pessoas_ckb_1") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00')";
            }
            elseif($cameras_pessoas == "pessoas_ckb_2") // OK
            {
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam01')";
            }            
            elseif($cameras_pessoas == "pessoas_ckb_3") // OK
            {
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam02')";
            }              
            elseif($cameras_pessoas == "pessoas_ckb_4") // OK
            {
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam03')";
            }               
            elseif($cameras_pessoas == "pessoas_ckb_5") // OK
            {
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam04')";
            }             
            
            
            elseif($cameras_pessoas == "pessoas_ckb_1_2") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam01')";
            }                 
            elseif($cameras_pessoas == "pessoas_ckb_1_3") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam02')";
            }               
            elseif($cameras_pessoas == "pessoas_ckb_1_4") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam03')";
            }               
            elseif($cameras_pessoas == "pessoas_ckb_1_5") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam04')";
            }                
            
            
            
            elseif($cameras_pessoas == "pessoas_ckb_1_2_3") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam01' OR camera_id='ms1041-cam02')";
            }
            elseif($cameras_pessoas == "pessoas_ckb_1_2_4") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam01' OR camera_id='ms1041-cam03')";
            }
            elseif($cameras_pessoas == "pessoas_ckb_1_2_5") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam01' OR camera_id='ms1041-cam04')";
            }


            elseif($cameras_pessoas == "pessoas_ckb_1_2_3_4") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam01' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam03')";
            }           
            elseif($cameras_pessoas == "pessoas_ckb_1_2_3_5") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam01' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam04')";
            }               
            elseif($cameras_pessoas == "pessoas_ckb_1_2_4_5") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam01' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam04')";
            }
     
            
            elseif($cameras_pessoas == "pessoas_ckb_1_3_4") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam03')";
            }
            elseif($cameras_pessoas == "pessoas_ckb_1_3_5") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam04')";
            }           
            
            elseif($cameras_pessoas == "pessoas_ckb_1_3_4_5") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam04')";
            }
            
            
            elseif($cameras_pessoas == "pessoas_ckb_1_4_5") // OK
            {
             //pessoas_ckb_1 - ms1041-cam00 - Visão Enloamento Saída CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam00' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam04')";
            }             
            
            
            elseif($cameras_pessoas == "pessoas_ckb_2_3") // OK
            {
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam02')";
            }                 
            elseif($cameras_pessoas == "pessoas_ckb_2_4") // OK
            {
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam03')";
            }             
            elseif($cameras_pessoas == "pessoas_ckb_2_5") // OK
            {
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam04')";
            }              
            
            
            elseif($cameras_pessoas == "pessoas_ckb_2_3_4") // OK
            {
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam03')";
            }                   
            elseif($cameras_pessoas == "pessoas_ckb_2_3_5") // OK
            {
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam04')";
            }             
            
            
            elseif($cameras_pessoas == "pessoas_ckb_2_3_4_5") // OK
            {
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam02' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam04')";
            }            
            
            
            elseif($cameras_pessoas == "pessoas_ckb_2_4_5") // OK
            {
             //pessoas_ckb_2 - ms1041-cam01 - Visão Cancelas Saída CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam01' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam04')";
            }              
            
            
            elseif($cameras_pessoas == "pessoas_ckb_3_4") // OK
            {
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam02' OR camera_id='ms1041-cam03')";
            }              
            elseif($cameras_pessoas == "pessoas_ckb_3_5") // OK
            {
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam02' OR camera_id='ms1041-cam04')";
            }             
            elseif($cameras_pessoas == "pessoas_ckb_3_4_5") // OK
            {
             //pessoas_ckb_3 - ms1041-cam02 - Subida Cancela Saida CO
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam02' OR camera_id='ms1041-cam03' OR camera_id='ms1041-cam04')";
            }             
            
            
            
            elseif($cameras_pessoas == "pessoas_ckb_4_5") // OK
            {
             //pessoas_ckb_4 - ms1041-cam03 - Lavador de Báscula
             //pessoas_ckb_5 - ms1041-cam04 - Visão Área das Balanças
             $pesquisa_pessoas = "data_leitura='$data'"." AND (camera_id='ms1041-cam03' OR camera_id='ms1041-cam04')";
            }              
            
            
            else // todas para evitar erros
            {
             // Todas as câmeras
             $pesquisa_pessoas = "data_leitura='$data'";
            }
            ...
            if($parecer_pessoas == "todos")
            {
              $pesquisa_pessoas = $pesquisa_pessoas; // Faz nada
            }
            elseif($parecer_pessoas == "pessoas_ckb_6")
            {
              $pesquisa_pessoas = $pesquisa_pessoas. " AND justificado='SIM'";
            }
            else
            {
             $pesquisa_pessoas = $pesquisa_pessoas. " AND justificado!='SIM'";
            ...
            include_once 'conexao_sva.php';
            $sql = $dbcon->query("SELECT * FROM pessoas WHERE ".$pesquisa_pessoas."AND deteccao_falsa !='SIM' ORDER BY id DESC");
            if(mysqli_num_rows($sql)>0)
            {
             while($dados = $sql->fetch_array())
             {
              ...
              <tr>
                <td class="pessoas_th1">
                  <div id='foto_pessoas'>
                      ...
                      <a href="javascript:pessoas_altera_video('<?php echo $url_do_arquivo ?>');" id='assistir'>Assistir</a>
                      <?php
                      if($justificado == "SIM")
                      {
                        $evento_justificado = $evento_justificado+1;  
                          //COLOCA NA COR VERDE #228B22
                       ?> 
                       <a href="javascript:pessoas_altera_justificar('<?php echo $id ?>');" style="background-color:#228B22;"  id='justificar' name='justificar'>Parecer Video</a>
                       <script>
                       //alert('verde');
                       </script>
                       <?php
                          ...
                          //COLOCA NA COR VERMELHO #DC143C;
                      ?>
                      <a href="javascript:pessoas_altera_justificar('<?php echo $id ?>');" style="background-color:#DC143C;"  id='justificar' name='justificar'>Parecer Video</a>
                      <script>
                       //alert('vermelho');
                       </script>
                      <?php
                      ...
                      ?>
                      <a href="javascript:deteccao_falsa_pessoas('<?php echo $id ?>');" id='ignorar' name='ignorar'>Detecção Falsa</a>
            ...
            if($encontrado==0)
             {
              ...
              <script>
                <?php $primeira_url = "./video_erro/video.m3u8"; ?>
                pessoas_altera_video('<?php echo $primeira_url ?>');
                var player = videojs('vpessoas_player1');
                player.play();
              </script>
...
<label id='lb_titulo_sirene'>Controle dos Audios</label>
   ...
   <div id='dados_sirene'>
    <label id='pessoas_valor_registro'><b>Condição: </b></label>
    <input type='text' id='pessoas_v_registro' name='pessoas_v_registro' value='Ativada!'/>
    <label id='pessoas_valor_nome'><b>Nome: </b></label>
    <input type='text' id='pessoas_v_nome' name='pessoas_v_nome' value='--'/>
    <label id='pessoas_lb_valor_parecer'><b>Parecer: </b></label>
    <textarea id='pessoas_v_parecer' name='pessoas_v_parecer' name="Text1" cols="56" rows="4">--</textarea>
...
<div id="div_filtrar_pessoas">
<label id="pessoas_lb_filtro1">Selecione os filtros desejados:</label>
<label id="pessoas_lb_filtro2">Seleção das câmeras:</label>

<input type="checkbox" id="pessoas_ckb_1" name="pessoas_ckb_1" checked>
<label id="pessoas_lb_filtro2_1">Visão Enloamento Saída CO</label>

<input type="checkbox" id="pessoas_ckb_2" name="pessoas_ckb_2" checked>
<label id="pessoas_lb_filtro2_2">Visão Cancelas Saída CO</label>

<input type="checkbox" id="pessoas_ckb_3" name="pessoas_ckb_3" checked>
<label id="pessoas_lb_filtro2_3">Subida Cancela Saida CO</label>

<input type="checkbox" id="pessoas_ckb_4" name="pessoas_ckb_4" checked>
<label id="pessoas_lb_filtro2_4">Lavador de Báscula</label>

<input type="checkbox" id="pessoas_ckb_5" name="pessoas_ckb_5" checked>
<label id="pessoas_lb_filtro2_5">Visão Área das Balanças</label>



<label id="pessoas_lb_filtro4">Seleção do parecer:</label>
<input type="checkbox" id="pessoas_ckb_6" name="pessoas_ckb_6" checked>
<label id="pessoas_lb_filtro4_1">Justificados</label>
<input type="checkbox" id="pessoas_ckb_7" name="pessoas_ckb_7" checked>
<label id="pessoas_lb_filtro4_2">Não justificados</label>

<input type="button" id="pessoas_salvar_filtro" name="pessoas_salvar_filtro" value="Salvar" onclick="clicou_salvar_filtro_pessoas(`${ref1.value}`);">
<input type="button" id="pessoas_sair_filtro" name="pessoas_sair_filtro" value="Cancelar" onclick="clicou_sair_filtro_pessoas();">
...
function pessoas_clicou_filtrar()
{
 document.getElementById('div_filtrar_pessoas').style.display = 'block';
}
...
location.href=`tela_va_cheio_vazio_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}&data=`+link_data+`&complemento=`+link_complemento+`&check=`+ link_check+`&cameras=`+resp_cameras+`&status=`+resp_cheio_vazio+`&parecer=`+resp_parecer;
...
function clicou_salvar_filtro_pessoas()
{
 //alert('salvar');
 var val_cameras_pessoas = "";
 var val_parecer_pessoas = "";

 //CAMERAS
 if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "todas";
 }
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_1";
 }
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_2";
 }
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_3";
 }
else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == false)
 {
 alert('pessoas_ckb_4');
  val_cameras_pessoas = "pessoas_ckb_4";
 }
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_5";
 }
 
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_1_2";
 }

 
 
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_1_3";
 }


 
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_1_4";
 }
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_1_5";
 }
 

 
  else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_1_2_3";
 }
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_1_2_4";
 }
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_1_2_5";
 }  
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_1_2_3_4";
 }
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_1_2_3_5";
 }
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_1_2_4_5";
 } 
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_1_3";
 }  
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_1_3_4";
 }   
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_1_3_5";
 }  
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_1_3_4_5";
 } 
 else if (document.getElementById('pessoas_ckb_1').checked == true && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_1_4_5";
 } 
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_2_3";
 } 
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_2_4";
 } 
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_2_5";
 } 
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_2_3_4";
 }
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_2_3_5";
 }  
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_2_3_4_5";
 } 
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == true && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_2_4_5";
 } 
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == false)
 {
  val_cameras_pessoas = "pessoas_ckb_3_4";
 }
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == false && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_3_5";
 }
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == true && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_3_4_5";
 } 
 else if (document.getElementById('pessoas_ckb_1').checked == false && document.getElementById('pessoas_ckb_2').checked == false && document.getElementById('pessoas_ckb_3').checked == false && document.getElementById('pessoas_ckb_4').checked == true && document.getElementById('pessoas_ckb_5').checked == true)
 {
  val_cameras_pessoas = "pessoas_ckb_4_5";
 } 
 else
 {
  val_cameras_pessoas = "todas"; // Caso tenha faltado algum entra todas!
 }
 ...
 //VERIFICA A CONDIÇÃO DO PARECER
 if (document.getElementById('pessoas_ckb_6').checked == true && document.getElementById('pessoas_ckb_7').checked == true)
 {
  val_parecer_pessoas = "todos";
 }
 else if (document.getElementById('pessoas_ckb_6').checked == true && document.getElementById('pessoas_ckb_7').checked == false)
 {
  val_parecer_pessoas = "pessoas_ckb_6";
 }
 else
 {
  val_parecer_pessoas = "pessoas_ckb_7";
 }

 document.getElementById('lb_cameras_pessoas').innerHTML = val_cameras_pessoas;
 document.getElementById('lb_parecer_pessoas').innerHTML = val_parecer_pessoas;

 var resp_cameras_pessoas = document.getElementById('lb_cameras_pessoas');
 var resp_parecer_pessoas = document.getElementById('lb_parecer_pessoas');
 var resp_cameras = document.getElementById('lb_cameras');
 var resp_parecer = document.getElementById('lb_parecer');
 var resp_cheio_vazio = document.getElementById('lb_cheio_vazio');

 resp_cameras_pessoas = resp_cameras_pessoas.innerHTML;
 resp_parecer_pessoas = resp_parecer_pessoas.innerHTML;
 ...
 document.getElementById('div_filtrar_pessoas').style.display = 'none';
 location.href=`tela_va_cheio_vazio_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}&data=`+link_data+`&complemento=`+link_complemento+`&check=`+link_check+`&status=`+resp_cheio_vazio+`&cameras=`+resp_cameras+`&cameras_pessoas=`+resp_cameras_pessoas+`&parecer=`+resp_parecer+`&parecer_pessoas=`+resp_parecer_pessoas;
...
function clicou_sair_filtro_pessoas()
{
  //alert('sair');
  document.getElementById('div_filtrar_pessoas').style.display = 'none';
}
...
function clicou_cheio_vazio()
{
    ...
    document.getElementById('v_cheio_vazio').disable = true; //Desabilita o botao cheio e vazio para VL
    document.getElementById('v_pessoas').style.display = 'none';
    document.getElementById('v_radar').style.display = 'none';
	document.getElementById('v_radar').disable = true; // Desabilita o botao do radar
    document.getElementById('v_relatorio').style.display = 'none';
	document.getElementById('v_relatorio').disable = true; // Desabilita o botao do relatorio
    document.getElementById('v_dashboard').style.display = 'none';
	document.getElementById('v_dashboard').disable = true; // Desabilita o botao do dashboard
    document.getElementById('v_configuracoes').style.display = 'none';
	document.getElementById('v_configuracoes').disable = true; // Desabilita o botao de configuracoes
    ...
    document.getElementById('div_info_zerar_pessoas').style.display='none'; // inicia ocultando div zerar
    document.getElementById('div_justificar_cheio_vazio').style.display='none'; // inicia ocultando div justificar
    document.getElementById('div_justificar_pessoas').style.display='none'; // inicia ocultando div justificar
    ...
    document.getElementById('div_justificativa_pessoas').style.display = 'none';// Inicia a tela justificativa oculta
    document.getElementById('div_filtrar_cheio_vazio').style.display = 'none'; // Inicia tela do filtro escondida
    document.getElementById('div_filtrar_pessoas').style.display = 'none'; // Inicia tela do filtro escondida
    document.getElementById('btn_salvar_editar_cheio_vazio').style.display = 'none';
    document.getElementById('btn_editar_cheio_vazio').style.display = 'none';
    document.getElementById('btn_editar_pessoas').style.display = 'none';
    document.getElementById('btn_salvar_editar_pessoas').style.display = 'none';
...
<div id="div_info_zerar_pessoas"  >
<label id='lb_info_zerar2'>ATENÇÃO!</label>
<label id='lb_info_zerar'>Deseja confirmar que este evento é uma detecção falsa?</label>
<input type="button" id="sim" name="sim" value="SIM" onclick="clicou_sim_pessoas(`${ref1.value}`);">
<input type="button" id="nao" name="nao" value="NÃO" onclick="clicou_nao_pessoas();">
</div>
...
<div id="div_justificar_pessoas"  >
<label id='lb_info_justificar2'>ATENÇÃO!</label>
<label id='lb_info_justificar'>Deseja justificar este evento?</label>
<input type="button" id="sim2_pessoas" name="sim2_pessoas" value="SIM" onclick="clicou_sim_justificar_pessoas(`${ref1.value}`);">
<input type="button" id="nao2_pessoas" name="nao2_pessoas" value="NÃO" onclick="clicou_nao_justificar_pessoas();">
</div>
...
<input type="button" id="parecer_padrao_entrada" name="parecer_padrao_entrada" value="Padrão" onclick="clicou_parecer_entrada_cheio_vazio();">
...
<div id="div_justificativa_pessoas"  >
<label id='lb_justificativa'>ATENÇÃO!</label>
<label id='lb_parecer_justificativa'>Insira um parecer sobre o evento:</label>
<textarea id='valor_parecer_pessoas' name='valor_parecer_pessoas' cols="40" rows="6"></textarea>
<input type="button" id="salvar_justificativa" name="salvar_justificativa" value="Salvar" onclick="clicou_salvar_justificativa_pessoas(`${ref1.value}`);">
...
<input type="button" id="sair_justificativa" name="sair_justificativa" value="Cancelar" onclick="clicou_sair_justificativa_pessoas();">
...
document.getElementById('cheio_vazio_titulo').innerHTML = "VA Cheio/Vazio VL - Detecções realizadas em " + dia+"/"+mes+"/"+ano;
...
location.href=`tela_va_cheio_vazio_vl.php?complemento=${criptografia2.value}&check=${criptografia.value}&data=${data2.value}&complemento=`+link_complemento+`&check=`+ link_check+`&cameras=`+resp_cameras+`&status=`+resp_cheio_vazio+`&parecer=`+resp_parecer;
...
<script>
  ...
  clicou_cheio_vazio();
    ...
    var link_cameras_pessoas = '<?php print $link_cameras_pessoas ?>';
    var link_status = '<?php print $link_status ?>';
    var link_parecer = '<?php print $link_parecer ?>';
    var link_parecer_pessoas = '<?php print $link_parecer_pessoas ?>';
    
    document.getElementById('lb_cheio_vazio').innerHTML = link_status;
    document.getElementById('lb_cameras').innerHTML = link_cameras;
    document.getElementById('lb_cameras_pessoas').innerHTML = link_cameras_pessoas;
    document.getElementById('lb_parecer').innerHTML = link_parecer;
    document.getElementById('lb_parecer_pessoas').innerHTML = link_parecer_pessoas;
    ...
    // TRATANDO OS FILTRO PARA PESSOAS
    if(link_cameras_pessoas == "todas")
    {
      //alert('todas');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = true;
      document.getElementById('pessoas_ckb_5').checked = true;
    }
    else if(link_cameras_pessoas == "pessoas_ckb_1")
    {
      //alert('pessoas_ckb_1');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = false;
      document.getElementById('pessoas_ckb_3').checked = false;
      document.getElementById('pessoas_ckb_4').checked = false;
      document.getElementById('pessoas_ckb_5').checked = false;
    }
    else if(link_cameras_pessoas == "pessoas_ckb_2")
    {
      //alert('pessoas_ckb_2');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = false;
      document.getElementById('pessoas_ckb_4').checked = false;
      document.getElementById('pessoas_ckb_5').checked = false;
    }
    else if(link_cameras_pessoas == "pessoas_ckb_3")
    {
      //alert('pessoas_ckb_3');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_4")
    {
      //alert('pessoas_ckb_4');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_5")
    {
      //alert('pessoas_ckb_5');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_2")
    {
      //alert('pessoas_ckb_1_2');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = false;
      document.getElementById('pessoas_ckb_4').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_3")
    {
      //alert('pessoas_ckb_1_3');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = false;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_4")
    {
      //alert('pessoas_ckb_1_4');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = false;
      document.getElementById('pessoas_ckb_3').checked = false;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_5")
    {
      //alert('pessoas_ckb_1_5');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = false;
      document.getElementById('pessoas_ckb_3').checked = false;
      document.getElementById('pessoas_ckb_4').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_2_3")
    {
      //alert('pessoas_ckb_1_2_3');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_2_4")
    {
      //alert('pessoas_ckb_1_2_4');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = false;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_2_5")
    {
      //alert('pessoas_ckb_1_2_5');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = false;
      document.getElementById('pessoas_ckb_4').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_2_3_4")
    {
      //alert('pessoas_ckb_1_2_3_4');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_2_3_5")
    {
      //alert('pessoas_ckb_1_2_3_5');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_2_4_5")
    {
      //alert('pessoas_ckb_1_2_3_4');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_3_4")
    {
      //alert('pessoas_ckb_1_3_4');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = false;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_3_5")
    {
      //alert('pessoas_ckb_1_3_5');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = false;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_3_4_5")
    {
      //alert('pessoas_ckb_1_3_4_5');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = false;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_1_4_5")
    {
      //alert('pessoas_ckb_1_4_5');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = false;
      document.getElementById('pessoas_ckb_3').checked = false;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_2_3")
    {
      //alert('pessoas_ckb_2_3');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_2_4")
    {
      //alert('pessoas_ckb_2_4');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = false;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_2_5")
    {
      //alert('pessoas_ckb_2_5');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = false;
      document.getElementById('pessoas_ckb_4').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_2_3_4")
    {
      //alert('pessoas_ckb_2_3_4');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_2_3_5")
    {
      //alert('pessoas_ckb_2_3_5');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_2_3_4_5")
    {
      //alert('pessoas_ckb_2_3_4_5');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_2_4_5")
    {
      //alert('pessoas_ckb_2_4_5');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = false;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_3_4")
    {
      //alert('pessoas_ckb_3_4');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = false;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_3_5")
    {
      //alert('pessoas_ckb_3_5');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = false;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = false;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_3_4_5")
    {
      //alert('pessoas_ckb_3_4_5');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = false;
      document.getElementById('pessoas_ckb_3').checked = true;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    else if(link_cameras_pessoas == "pessoas_ckb_4_5")
    {
      //alert('pessoas_ckb_4_5');
      document.getElementById('pessoas_ckb_1').checked = false;
      document.getElementById('pessoas_ckb_2').checked = false;
      document.getElementById('pessoas_ckb_3').checked = false;
      document.getElementById('pessoas_ckb_4').checked = true;
    ...
    { // PARA EVITAR ERROS CASO TENHA FICADO ALGUM PARA TRAS! 
      //alert('todas');
      document.getElementById('pessoas_ckb_1').checked = true;
      document.getElementById('pessoas_ckb_2').checked = true;
      document.getElementById('pessoas_ckb_3').checked = true;
    ...
    //AGORA TRATA A SELEÇÃO DO PARECER PESSOAS
    if(link_parecer_pessoas == "todos")
    {
      document.getElementById('pessoas_ckb_6').checked = true;
      document.getElementById('pessoas_ckb_7').checked = true;
    }
    else if(link_parecer_pessoas == "pessoas_ckb_6")
    {
      document.getElementById('pessoas_ckb_6').checked = true;
      document.getElementById('pessoas_ckb_7').checked = false;
    }
    else
    {
      document.getElementById('pessoas_ckb_6').checked = false;
      document.getElementById('pessoas_ckb_7').checked = true;
    }
    
    //alert(link_cameras_pessoas);
...
function clicou_sim_pessoas(link_video)
{
  var id = document.getElementById('ref1');
 id = id.value;
 var nome = document.getElementById('colaborador');
 ...
 //alert(link_video);
 $.ajax({
           url: 'salvar_deteccao_falsa_ocr_pessoas.php',
           type: 'GET',
           dataType: 'json',
           data: {'id': id,'registro': registro,'nome': nome,'parecer': parecer},
           success: function(resultado){
             if(resultado == "salvo")
             {
              document.getElementById('div_info_zerar_pessoas').style.display = 'none';
              document.location.reload(true);//recarrega a pagina!
             }
             else
             {
...
function clicou_parecer_entrada_cheio_vazio()
{
 //alert('entrada');
 ...
 else
 {
  ...
  $.ajax({
           ...
           success: function(resultado){
             if(resultado == "salvo")
             {
              document.getElementById('div_justificativa_cheio_vazio').style.visibility = 'hidden';
              document.getElementById("tabela").disabled = false;
...
function clicou_salvar_justificativa_pessoas(link_video)
{
 //alert('entrou');
 var parecer = document.getElementById('valor_parecer_pessoas');
 parecer = parecer.value;
 var id = document.getElementById('ref1');
 id = id.value;
 var nome = document.getElementById('colaborador');
 ...
 else
 {
  //alert('entrou');
  $.ajax({
           url: 'salvar_parecer_ocr_pessoas.php',
           type: 'GET',
           dataType: 'json',
           data: {'id': id,'registro': registro,'nome': nome,'parecer': parecer},
           success: function(resultado){
             if(resultado == "salvo")
             {
              document.getElementById('div_justificativa_pessoas').style.visibility = 'hidden';
              //Antes de recarregar, limpar os dados da justificativa
              document.getElementById('valor_parecer_pessoas').value = "";
              document.location.reload(true);//recarrega a pagina!
             }
             else
             {
...
function clicou_sair_justificativa_pessoas()
{
 //alert("clicou_sair_justificativa");  
 var link_parecer = document.getElementById('valor_parecer');
 link_parecer.innerHTML = "";
 
 document.getElementById('div_justificativa_pessoas').style.display = 'none';
...
function clicou_sim_justificar_pessoas(link_video)
{
 //alert("clicou_sim_justificar");
 // Pesquisa se o parecer pode ser padrao!
 $.ajax({
           url: 'validar_parecer_pessoas.php',
           type: 'GET',
           dataType: 'json',
           data: {'id': link_video},
           success: function(resultado)
           {
            resultado == "erro"; // trava por enquanto pois nao temos parecer padrao para deteccoa de pessoas ainda
 ...
 document.getElementById('div_justificar_pessoas').style.display = 'none';
 document.getElementById('div_justificativa_pessoas').style.display = 'block';
}
...
function clicou_nao_justificar_pessoas()
{
 //alert("clicou_nao_justificar");   
 document.getElementById('div_justificar_pessoas').style.display = 'none';
...
INPUT#btn_editar_pessoas:hover
{
 background-color: #D3D3D3; /* Preto */
 color: white;
}
INPUT#btn_editar_pessoas:active {
  background-color: #696969;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
...
INPUT#btn_salvar_editar_pessoas{
    position: absolute;
    left: 85%;
    top: -2%;
    padding: 2px;
...
INPUT#btn_salvar_editar_pessoas:hover
{
 background-color: #D3D3D3; /* Preto */
 color: white;
}
INPUT#btn_salvar_editar_pessoas:active {
  background-color: #696969;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}

IMG#pessoas_btn_calendario{
    position: absolute;
    left: 34%;
    top: -6%;
    padding: 5px;
...
IMG#pessoas_btn_calendario:hover
{
 background-color: #D3D3D3; /* Preto */
 color: white;
}
IMG#pessoas_btn_calendario:active {
  background-color: #696969;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}

IMG#pessoas_btn_filtro{
    position: absolute;
    left: 38.5%;
    top: -6%;
    padding: 5px;
...
IMG#pessoas_btn_filtro:hover
{
 background-color: #D3D3D3; /* Preto */
 color: white;
}
IMG#pessoas_btn_filtro:active {
  background-color: #696969;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
...
LABEL#pessoas_lb_valor_parecer{
    position: absolute;
    left: 4%;
    top: 30%;
    font: normal 12pt verdana;
...
DIV#div_info_zerar_cheio_vazio{
  position: absolute;
    left: 37%;
    top: 28%;
    background-color: #363636;
...
INPUT#pessoas_salvar_filtro:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#pessoas_salvar_filtro:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}

INPUT#pessoas_sair_filtro
{
    color: #FFFFFF;
    margin-left: 0px;
    position: absolute;
...
INPUT#pessoas_sair_filtro:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#pessoas_sair_filtro:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
...
INPUT#sim2_pessoas:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#sim2_pessoas:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
...
INPUT#nao2_pessoas:hover
{
 background-color: #555555; /* Preto */
 color: white;
}
INPUT#nao2_pessoas:active {
  background-color: #00008B;
  box-shadow: 0 5px #666;
  transform: translateY(4px);
}
...
TEXTAREA#valor_parecer_pessoas{
    position: absolute;
    color: #000000;
    font: normal 12pt verdana;
    left:4%;
