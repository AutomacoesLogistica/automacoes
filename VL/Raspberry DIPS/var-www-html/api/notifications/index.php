...
if($status=='Ausencia de Dip')
{
 ...
 $sql = $dbcon->query("INSERT INTO deteccao SET tipo_evento='$tipo_evento',media_server_id='$media_server_id',detected_at='$detected_at',data_leitura='$data_completa',hora_leitura='$horario',local_api='$local_api',camera='$camera',saida_detectada='',video_placa='$video_url',imagem='$imagem',valor_placa='$status',condicao='',justificado='',registro='',nome='',justificativa='',placa='',resumo_transportadora='',tipo='',deteccao_falsa='',epc='',gagf='',gscs='',nomination='',material='',liquido='' ");
