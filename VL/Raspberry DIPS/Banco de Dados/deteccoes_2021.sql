...
--
-- Estrutura da tabela `deteccoes_2021`
--

CREATE TABLE `deteccoes_2021` (
...
--
-- Extraindo dados da tabela `deteccoes_2021`
--

INSERT INTO `deteccoes_2021` (`id`, `dias`, `janeiro`, `fevereiro`, `março`, `abril`, `maio`, `junho`, `julho`, `agosto`, `setembro`, `outubro`, `novembro`, `dezembro`) VALUES
...
--
-- Indexes for table `deteccoes_2021`
--
ALTER TABLE `deteccoes_2021`
  ADD PRIMARY KEY (`id`);
