...
--
-- Estrutura da tabela `cheio_vazio_descartado`
--

CREATE TABLE `cheio_vazio_descartado` (
  `id` int(11) NOT NULL,
  ...
  `id_original` varchar(10) DEFAULT NULL,
...
--
-- Indexes for table `cheio_vazio_descartado`
--
ALTER TABLE `cheio_vazio_descartado`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cheio_vazio_descartado`
--
ALTER TABLE `cheio_vazio_descartado`
