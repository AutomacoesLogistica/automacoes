                            ...
                            if(tag=="442001" and epc != ultima_epc_cavalo):
                                ...
                                if(antena=="0"):
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "INSERT INTO Controle_2_01(ponto, condicao, dia,mes,ano,vdata, vhora,data_hora,epc) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "UPDATE atualizacao SET antena0 = %s WHERE ponto='Controle 2'"
                                        msg = ('OK',)
                                        mycursor.execute(sql,msg);
                                        mydb.commit();
                                    except Exception as e:
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "UPDATE atualizacao SET antena1 = %s WHERE ponto='Controle 2'"
                                        msg = ('OK',)
                                        mycursor.execute(sql,msg);
                                        mydb.commit();
                                    except Exception as e:
                                ...
                                url_local2 = 'http://192.168.30.73/dashboard/dashboard_ponto_controle_2.php'
                                dados = {'epc': epc}
                                texto = None
                                try:
                                ...
                                if ( n_leitura == "0" ):
                                    ...
                                    url_local = 'http://192.168.30.73/dashboard/validacao_match.php'
                                    dados = {'rodar':'rodar'}
                                    texto = None
                                    try:
                                    ...
                                    url_local2 = 'http://192.168.30.73/dashboard/verifica_tempo.php'
                                    dados = {'rodar':'rodar'}
                                    texto = None
                                    try:
                                        requisicao = requests.get(url_local2,dados)
                            ...
                            if (leitura_geral >10 or leitura_geral< -10):
                                ...
                                if(leituras_0 == 0):
                                    ...
                                    try:
                                        ...
                                        msg = ("0","Controle de Acesso 2","nao",data_leitura, hora_leitura,);
                                        mycursor.execute(sql,msg);
                                        mydb.commit()
                                    except Exception as e:
                                        print("Requisicao deu erro:", e)
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "INSERT INTO alerta_antenas(antena,local,tratado, data_leitura, hora_leitura) VALUES (%s, %s, %s, %s, %s)"
                                        msg = ("1","Controle de Acesso 2","nao", data_leitura, hora_leitura,);
                                        mycursor.execute(sql,msg);
                                        mydb.commit()
                                    except Exception as e:
                                        print("Requisicao deu erro:", e)
...
while Exit==False:
 ...
 if(ciclo ==4):
    ...
    try:
        ...
        mycursor = mydb.cursor()
        sql = "UPDATE atualizacao SET data_atualizacao = %s, hora_atualizacao = %s WHERE ponto='Controle 2'"
        msg = (data_atualizacao, hora_atualizacao,)
        mycursor.execute(sql,msg);
        mydb.commit();
    except Exception as e:
