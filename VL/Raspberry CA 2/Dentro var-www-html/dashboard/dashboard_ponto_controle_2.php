  ...
  $turno_atual = $turno3;  
    ...
    else
    {
     ...
     if($encontrados_historico == 1) // Posso atualizar
     {
      ...
      include_once 'conexao_dashboard.php';
      $sql = $dbcon->query("UPDATE historico SET turno='$turno_atual', v_status='Controle Acesso',valor_ponto='$valor_ponto', $ponto='Controle 2', $data_leitura='$data', $hora_leitura='$hora' WHERE id='$id_banco_historico'");
