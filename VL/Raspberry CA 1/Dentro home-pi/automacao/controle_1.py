                        ...
                        if (tamanho == 24):
                            if(tag=="442001" and epc != ultima_epc_cavalo):
                                ...
                                if(antena=="2"):
								    ...
								    #Salvo como antena 1 - FISICAMENTE HJ É A 3
                                ...
                                url_local2 = 'http://192.168.30.72/dashboard/dashboard_ponto_controle_1.php'
                                dados = {'epc': epc}
                                texto = None
                                try:
                                ...
                                if ( n_leitura == "0" ):
                                    ...
                                    url_local = 'http://192.168.30.72/dashboard/validacao_match.php'
                                    dados = {'rodar':'rodar'}
                                    texto = None
                                    try:
                                    ...
                                    url_local2 = 'http://192.168.30.72/dashboard/verifica_tempo.php'
                                    dados = {'rodar':'rodar'}
                                    texto = None
                                    try:
                                        requisicao = requests.get(url_local2,dados)
