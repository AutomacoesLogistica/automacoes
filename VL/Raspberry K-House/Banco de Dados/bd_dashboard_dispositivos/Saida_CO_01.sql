...
--
-- Host: localhost:3306
-- Generation Time: 21-Abr-2022 às 16:10
...
--
-- Estrutura da tabela `Saida_CO_01`
--

CREATE TABLE `Saida_CO_01` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `Saida_CO_01`
--
ALTER TABLE `Saida_CO_01`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `Saida_CO_01`
--
ALTER TABLE `Saida_CO_01`
