...
--
-- Estrutura da tabela `Entrada_BH_01`
--

CREATE TABLE `Entrada_BH_01` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `Entrada_BH_01`
--
ALTER TABLE `Entrada_BH_01`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `Entrada_BH_01`
--
ALTER TABLE `Entrada_BH_01`
