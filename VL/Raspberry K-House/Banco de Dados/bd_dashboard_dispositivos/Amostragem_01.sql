...
--
-- Estrutura da tabela `Amostragem_01`
--

CREATE TABLE `Amostragem_01` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `Amostragem_01`
--
ALTER TABLE `Amostragem_01`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `Amostragem_01`
--
ALTER TABLE `Amostragem_01`
