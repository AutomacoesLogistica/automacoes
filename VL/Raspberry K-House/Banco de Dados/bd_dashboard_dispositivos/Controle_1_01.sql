...
--
-- Estrutura da tabela `Controle_1_01`
--

CREATE TABLE `Controle_1_01` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `Controle_1_01`
--
ALTER TABLE `Controle_1_01`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `Controle_1_01`
--
ALTER TABLE `Controle_1_01`
