<?php
     ...
     $array_placa_carreta_saida = array();
     $array_placa_cavalo_saida = array();
      ...
      if($tamanho_data==10 && $tamanho_hora == 8)
      {
        ...
        */
        ...
        if((intval($minuto)>10 || intval($hora)>0 ) && $tipo == 'Saida')
        {
            ...
            $array_placa_cavalo_saida[$encontrados_saida] = $placa_cavalo;
            $array_placa_carreta_saida[$encontrados_saida] = $placa_carreta;
        ...
        else if (intval($hora)>3)
        {
            ...
            $array_placa_cavalo_3mais[$encontrados_3mais] = $placa_cavalo;
            $array_placa_carreta_3mais[$encontrados_3mais] = $placa_carreta;
            $encontrado = intval($encontrado) + 1;
    ...
    if($encontrado != 0)
    {
      ...
      for($i=0;$i<$tamanho_array_saida;$i++)
      {  
       if($array_placa_cavalo_saida[$i]=='-'){$array_placa_cavalo_saida[$i] = '';}
       if($array_placa_carreta_saida[$i]=='-'){$array_placa_carreta_saida[$i] = '';} 
       
       //echo 'Placa Cavalo : ' . $array_placa_cavalo_saida[$i];
       //echo '</BR>';
       //echo 'Placa Carreta : ' . $array_placa_carreta_saida[$i];
       //echo '</BR>';
       
      include_once 'conexao_dashboard.php';
      $sql = $dbcon->query("SELECT * FROM historico WHERE ( placa_cavalo = '$array_placa_cavalo_saida[$i]' AND placa_carreta='$array_placa_carreta_saida[$i]' AND v_status ='Saiu da Planta') ORDER BY id DESC LIMIT 1");
      if(mysqli_num_rows($sql)>0)
      {
       ...
       */  
        ...
        */
        ...
        if(mysqli_num_rows($sql)>0)
        {
         ...
         //echo (' Atualizou lista_turno_dashboard');
         ...
         if(mysqli_num_rows($sql)>0)
         {
          ...
          //echo (' Rodou atualizando encerramentos');
         }
      ...
      {
        //echo('entrou tratando ttp saida');
      ...
      {
        //echo('entrou tratando ttp entradas');
     ...
     //echo('Atualizou historico_complemento');
      ...
      {
       //echo('Não achou historico');
       $array_placa_cavalo_saida[$i];
       $array_placa_carreta_saida[$i];
       date_default_timezone_set('America/Sao_Paulo');
       $data = date('d/m/Y');
       $hora = date('H:i:s');
       ...
       include_once 'conexao_dashboard.php';
       $sql = $dbcon->query("INSERT INTO erros_saida(placa_cavalo,placa_carreta,data_leitura,hora_leitura)VALUES('$array_placa_cavalo_saida[$i]','$array_placa_carreta_saida[$i]','$data','$hora')");
      ...
      } // F//echo o  for($i=0;$i<$tamanho_array_saida;$i++)
      ...
      for($i=0;$i<$tamanho_array_3mais;$i++)
      {  
       if($array_placa_cavalo_3mais[$i]=='-'){$array_placa_cavalo_3mais[$i] = '';}
       if($array_placa_carreta_3mais[$i]=='-'){$array_placa_carreta_3mais[$i] = '';} 
       ...
       */
       ...
       {  
        $array_placa_cavalo_3mais[$i];
        $array_placa_carreta_3mais[$i];
        date_default_timezone_set('America/Sao_Paulo');
        $data = date('d/m/Y');
        $hora = date('H:i:s');
        //Agora insiro no banco para tratar depois
        include_once 'conexao_dashboard.php';
        $sql = $dbcon->query("INSERT INTO erros_3mais(placa_cavalo,placa_carreta,data_leitura,hora_leitura)VALUES('$array_placa_cavalo_3mais[$i]','$array_placa_carreta_3mais[$i]','$data','$hora')");
       }
      } //Fecha o for
