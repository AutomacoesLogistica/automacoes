...
<head>
    ...
    <script src="./javascript/javascript_ajax.js"></script>
...
<label id="lb_turno_atual">Turno Atual: Letra D</label>
...
<label id="titulo_enc_antena">Antena: <?php print $enc_antena ?></label>
...
<label id="titulo_movimentacoes_dia">Movimentações Dia</label>
...
var link_v_dia = window.document.getElementById('titulo_movimentacoes_dia_1');
link_v_dia.innerHTML = v_dia;
...
{
 location.href='./tela_encerramentos.php?vezes=0$nvezes=2';//Por default passo 2
}
else
{
 if(link_vezes != '-1')
