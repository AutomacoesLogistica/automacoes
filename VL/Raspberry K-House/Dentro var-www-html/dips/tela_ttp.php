...
include_once 'conexao_dashboard.php';
$sql = $dbcon->query("SELECT * FROM lista_turno_dashboard WHERE data='$v_data'");
...
include_once 'conexao_dashboard.php';
$sql = $dbcon->query("SELECT * FROM ttp_entrada_a_saida WHERE data_entrada ='$v_data' ORDER BY data_hora DESC LIMIT 2000");
if(mysqli_num_rows($sql)>0)
{
...
include_once 'conexao_dashboard.php';
$sql = $dbcon->query("SELECT * FROM ttp_ca_a_saida  WHERE data_ca ='$v_data'  ORDER BY data_hora DESC LIMIT 2000");
if(mysqli_num_rows($sql)>0)
{
 while($dados = $sql->fetch_array())
 {
...
include_once 'conexao_dashboard.php';
$sql = $dbcon->query("UPDATE lista_turno_dashboard SET ttp_dia='$ttp_dia_ca',ttp_dia_entrada='$ttp_dia_entrada',ttp_turno1='$val_ttp_turno1_ca',ttp_turno2='$val_ttp_turno2_ca',ttp_turno3='$val_ttp_turno3_ca' WHERE data='$v_data'");  
...
if( link_vezes >= 6)
{
 location.href='./tela_dispositivos.php?vezes=0$nvezes=2';//Por default passo 2 vezes apenas
}
else
{
 if(link_vezes != '-1')
