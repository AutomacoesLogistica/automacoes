...
<label id='lb_nao' name='lb_nao' onclick='clicou_nao();'>NÃO</label>
...
function atualizar()
{
    location.href=`tela_tablet_pc.php`;
}
</script>
...
if(id==0)
{
 ...
 if(link_vez == 3)
 {
    window.setTimeout( "location.href=`tela_tablet_pc.php?vez=0`",5000);   
 }
 else
 {
    window.setTimeout( "location.href=`tela_tablet_pc.php?vez=${link_vez}`",3000);   
 }
