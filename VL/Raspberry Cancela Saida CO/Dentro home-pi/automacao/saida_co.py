    ...
    def run(self):
        ...
        while self._running:
            try:
                ...
                if(mensagem.startswith('b') and len(mensagem)>20):
                    if(mensagem.endswith("'")):
                        ...
                        if (tamanho == 24):
                            if(tag=="442001" and epc != ultima_epc_cavalo):
                                ...
                                url_local2 = 'http://192.168.30.123/dashboard/dashboard_ponto_saida_co.php'
                                dados = {'epc': epc}
                                texto = None
                                try:
                                ...
                                if ( n_leitura == "0" ):
                                    ...
                                    url_local = 'http://192.168.30.123/dashboard/validacao_match.php'
                                    dados = {'rodar':'rodar'}
                                    texto = None
                                    try:
                            ...
                            if (leitura_geral >50 or leitura_geral< -50):
                                leitura_geral = 0
                                ...
                                if(leituras_0 == 0):
                                    ...
                                    try:
                                        ...
                                        msg = ("0","Saida CO","nao",data_leitura, hora_leitura,);
                                        mycursor.execute(sql,msg);
                                        mydb.commit()
                                    except Exception as e:
                                        print("Requisicao deu erro:", e)
                                    ...
                                    try:
                                        ...
                                        mycursor = mydb.cursor()
                                        sql = "INSERT INTO alerta_antenas(antena,local,tratado, data_leitura, hora_leitura) VALUES (%s, %s, %s, %s, %s)"
                                        msg = ("1","Saida CO","nao", data_leitura, hora_leitura,);
                                        mycursor.execute(sql,msg);
                                        mydb.commit()
                                    except Exception as e:
                                        print("Requisicao deu erro:", e)
...
while Exit==False:
 ...
 if(ciclo ==4):
    ...
    try:
        ...
        mycursor = mydb.cursor()
        sql = "UPDATE atualizacao SET data_atualizacao = %s, hora_atualizacao = %s WHERE ponto='Saida CO'"
        msg = (data_atualizacao, hora_atualizacao,)
        mycursor.execute(sql,msg);
        mydb.commit();
    except Exception as e:
